...
try{
 ...
 for(const width of [390,1366]){
  ...
  console.log(`PASS ${width}px actual store + registry hook: keyboard retry, loading, fresh success, stale error fenced, zero writes, no overflow/pageerror`);await context.close();
 }
