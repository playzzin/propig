...
exports.onEmoticonJobContinuationCreated = exports.onEmoticonJobTerminalSettled = exports.onEmoticonJobCancellationRequested = exports.onEmoticonJobCreated = exports.recoverStalledEmoticonJob = void 0;
...
const animationContainer_1 = require("../emoticonStudio/animationContainer");
...
const identityFingerprint_1 = require("../emoticonStudio/identityFingerprint");
const repairContinuation_1 = require("../emoticonStudio/repairContinuation");
const batches_1 = require("../emoticonStudio/batches");
const verifiedDynamicParent_1 = require("../emoticonStudio/verifiedDynamicParent");
const manualFrameImport_1 = require("../emoticonStudio/manualFrameImport");
const outputPlanPolicy_1 = require("../emoticonStudio/outputPlanPolicy");
const modelPolicy_1 = require("../emoticonStudio/modelPolicy");
const quickComposite_1 = require("../emoticonStudio/quickComposite");
const platformPolicy_1 = require("../emoticonStudio/platformPolicy");
const firestore_3 = require("../firestore");
const openrouterUsage_1 = require("../openrouterUsage");
const hostingAiRuntime_1 = require("../api/hostingAiRuntime");
...
const CONTINUATION_WORK_BUDGET_MS = 510000;
...
const MIN_IMAGE_CALL_BUDGET_MS = 330000;
const MIN_REVIEW_CALL_BUDGET_MS = 150000;
const MIN_RENDER_BUDGET_MS = 120000;
const CONTINUATION_LEASE_MS = 570000;
...
const INITIAL_RUN_LEASE_MS = jobRecovery_1.EMOTICON_INITIAL_RUN_LEASE_MS;
const CONTINUATION_TTL_MS = 7 * 24 * 60 * 60 * 1000;
const MAX_CONTINUATION_RETRIES = 2;
const MAX_CONTINUATION_DELIVERY_ATTEMPTS = 2;
const EMOTICON_DAILY_LIMITS = (0, rateLimits_1.getEmoticonStudioDailyLimits)();
const EMOTICON_COST_LIMITS = (0, rateLimits_1.getEmoticonStudioCostLimits)();
const FRAME_REPAIR_VALIDATION = 'local-variation+pose-semantic+sequence-motion+output-inspection';
const EMOTICON_AI_RUNTIME_SNAPSHOT_VERSION = 1;
function parseEmoticonAiRuntimeSnapshot(value) {
    ...
    const fallbackModels = Array.isArray(candidate.fallbackModels)
        ? candidate.fallbackModels
            ...
            .slice(0, 3)
        : [];
    if (candidate.version !== EMOTICON_AI_RUNTIME_SNAPSHOT_VERSION
        || !textModel
        || !imageModel
        || typeof candidate.capturedAtMs !== 'number'
        || !Number.isFinite(candidate.capturedAtMs))
        return null;
    return Object.assign(Object.assign({ version: EMOTICON_AI_RUNTIME_SNAPSHOT_VERSION, textModel,
        imageModel, fallbackModels: [...new Set(fallbackModels)], capturedAtMs: candidate.capturedAtMs, settingsUpdatedAt: typeof candidate.settingsUpdatedAt === 'string'
            ? candidate.settingsUpdatedAt
            : null }, (candidate.reasoningEffort === 'low' ? { reasoningEffort: 'low' } : {})), (candidate.policyId === modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE
        ? { policyId: modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE }
        : {}));
}
async function resolveEmoticonAiRuntime(params) {
    ...
    const liveRuntime = await (0, hostingAiRuntime_1.getHostingAiRuntime)();
    const stored = parseEmoticonAiRuntimeSnapshot(params.job.openRouterRuntimeSnapshot);
    if (stored) {
        return Object.assign(Object.assign(Object.assign(Object.assign({}, liveRuntime), { model: stored.textModel, imageModel: stored.imageModel, fallbackModels: stored.fallbackModels, updatedAt: stored.settingsUpdatedAt }), (stored.reasoningEffort ? { reasoningEffort: stored.reasoningEffort } : {})), (stored.policyId ? { policyId: stored.policyId } : {}));
    }
    const useGptLight = params.resourceMode === 'efficient'
        && params.aiGenerationProfile === modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE;
    const policy = useGptLight
        ? (0, modelPolicy_1.resolveEmoticonGenerationModelPolicy)({
    ...
    const resolvedRuntime = Object.assign(Object.assign(Object.assign(Object.assign({}, liveRuntime), { model: policy.textModel, imageModel: policy.imageModel, fallbackModels: policy.fallbackModels }), (policy.reasoningEffort ? { reasoningEffort: policy.reasoningEffort } : {})), (useGptLight ? { policyId: modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE } : {}));
    const snapshot = Object.assign(Object.assign({ version: EMOTICON_AI_RUNTIME_SNAPSHOT_VERSION, textModel: resolvedRuntime.model, imageModel: resolvedRuntime.imageModel, fallbackModels: resolvedRuntime.fallbackModels, capturedAtMs: Date.now(), settingsUpdatedAt: liveRuntime.updatedAt }, (resolvedRuntime.reasoningEffort
...
function isFrameContinuationState(value) {
...
async function assertLinkedProjectItemClaim(params) {
    ...
    if (params.request.projectId) {
        const projectSnapshot = await firestore_3.db.doc(`users/${params.userId}/emoticonProjects/${params.request.projectId}`).get();
        if (!projectSnapshot.exists || ((_a = projectSnapshot.data()) === null || _a === void 0 ? void 0 : _a.deletionLocked) === true) {
            throw new EmoticonProjectDeletionLockedError();
        }
    }
    if (['plan', 'profile', 'sheet_plan'].includes(params.request.mode))
        return;
    if (!params.request.projectId || !params.request.projectItemId) {
        throw new EmoticonStaleProjectItemClaimError();
    }
    const itemSnapshot = await firestore_3.db.doc(`users/${params.userId}/emoticonProjects/${params.request.projectId}/items/${params.request.projectItemId}`).get();
...
function cancellationUpdate(job) {
    return Object.assign(Object.assign(Object.assign({ status: 'cancelled', progress: typeof job.progress === 'number' ? job.progress : 0, statusMessage: '사용자가 작업을 취소했어요.', error: null, resumeAvailable: false }, (job.frameContinuation && typeof job.frameContinuation === 'object'
        ? { 'frameContinuation.state': 'cancelled' }
        : {})), (!job.cancelledAt ? { cancelledAt: firestore_1.FieldValue.serverTimestamp() } : {})), { updatedAt: firestore_1.FieldValue.serverTimestamp() });
}
async function finalizeJobCancellation(userId, jobId) {
...
async function isJobCancellationRequested(userId, jobId) {
    const snapshot = await firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`).get();
    if (!snapshot.exists)
        return false;
    const job = snapshot.data() || {};
    if (job.userId !== userId)
...
async function assertJobActive(userId, jobId) {
    const snapshot = await firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`).get();
    if (!snapshot.exists)
        throw new Error('The emoticon job no longer exists.');
    const job = snapshot.data() || {};
    if (job.userId !== userId)
        throw new Error('The emoticon job owner does not match its document path.');
...
async function updateActiveJob(userId, jobId, data, fence) {
    const jobRef = firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`);
    let cancelled = false;
    await firestore_3.db.runTransaction(async (transaction) => {
        ...
        const savedContinuation = job.frameContinuation && typeof job.frameContinuation === 'object'
            ...
            : null;
        if (job.generationRunToken !== fence.generationRunToken
            || (fence.continuationToken !== undefined && (savedContinuation === null || savedContinuation === void 0 ? void 0 : savedContinuation.token) !== fence.continuationToken)) {
        ...
        transaction.update(jobRef, Object.assign(Object.assign(Object.assign({}, heartbeat), data), { updatedAt: firestore_1.FieldValue.serverTimestamp() }));
        if (fence.continuationToken !== undefined) {
            transaction.update(firestore_3.db.collection('emoticonStudioContinuations').doc(fence.continuationToken), {
...
function characterCacheId(userId, sourceStoragePath, identityFingerprint) {
    return (0, node_crypto_1.createHash)('sha256')
        .update(`${userId}:${sourceStoragePath}:${identityFingerprint}`)
        .digest('hex');
}
async function loadCharacterAnalysisCache(userId, sourceStoragePath, identityFingerprint, expectedReferenceCount, requestedAnalysisMode) {
    var _a;
    const cacheRef = firestore_3.db.doc(`emoticonStudioCharacterProfiles/${characterCacheId(userId, sourceStoragePath, identityFingerprint)}`);
    ...
    if (data.userId !== userId
        ...
        || data.identityFingerprintVersion !== identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION)
        return null;
    const profile = schema_1.emoticonCharacterProfileSchema.safeParse(data.characterProfile);
    const presets = schema_1.emoticonPresetSchema.array().max(64).safeParse(data.suggestedPresets);
    if (!profile.success || !presets.success)
        return null;
    const analysis = schema_1.emoticonCharacterAnalysisSchema.safeParse(data.characterAnalysis);
    const analysisMode = data.analysisMode === 'efficient' || data.analysisMode === 'premium'
        ? data.analysisMode
        : undefined;
    const analysisMeetsRequestedMode = !requestedAnalysisMode || (((_a = data.characterAnalysis) === null || _a === void 0 ? void 0 : _a.analysisRevision) === 2
        && (requestedAnalysisMode === 'efficient' || analysisMode === 'premium'));
    if (data.characterAnalysis !== undefined
        && (!analysis.success || analysis.data.referenceCount !== expectedReferenceCount))
        return null;
    return Object.assign(Object.assign({ characterProfile: profile.data, suggestedPresets: presets.data }, (analysis.success && analysisMeetsRequestedMode ? { characterAnalysis: analysis.data } : {})), (analysisMode ? { analysisMode } : {}));
}
async function saveCharacterAnalysisCache(params) {
    const cacheRef = firestore_3.db.doc(`emoticonStudioCharacterProfiles/${characterCacheId(params.userId, params.sourceStoragePath, params.identityFingerprint)}`);
    await cacheRef.set(Object.assign(Object.assign({ userId: params.userId, sourceStoragePath: params.sourceStoragePath, sourceFingerprint: params.sourceFingerprint, referenceSetFingerprint: params.referenceSetFingerprint, identityFingerprint: params.identityFingerprint, identityFingerprintVersion: identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION, characterProfile: params.plan.characterProfile, suggestedPresets: params.plan.suggestedPresets }, (params.characterAnalysis ? { characterAnalysis: params.characterAnalysis } : {})), { updatedAt: firestore_1.FieldValue.serverTimestamp() }), { merge: true });
}
async function saveDedicatedCharacterAnalysisCache(params) {
    ...
    await cacheRef.set({
        ...
        identityFingerprintVersion: identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION,
        characterAnalysis: params.characterAnalysis,
        analysisMode: params.analysisMode,
        characterProfile: (0, director_1.characterAnalysisToLegacyProfile)(params.characterAnalysis),
        suggestedPresets: [],
        updatedAt: firestore_1.FieldValue.serverTimestamp(),
    }, { merge: true });
}
async function runCharacterProfilePlanningPipeline(params) {
    ...
    await params.update(Object.assign(Object.assign({ status: 'analyzing', progress: 12, statusMessage: params.request.mode === 'profile'
            ? '참조 이미지에서 캐릭터 외형과 스타일을 분석하고 있어요.'
            : '적용된 캐릭터 분석을 기준으로 시트 항목을 기획하고 있어요.', error: null, sourceImageUrl: params.sourceImageUrl, sourceCanonicalStoragePath: params.sourceStoragePath, sourceFingerprint: params.sourceFingerprint, referenceSetFingerprint: params.referenceSetFingerprint, canonicalReferenceUrls: params.additionalReferenceUrls }, (params.identityReferenceUrl
        ? { canonicalIdentityReferenceUrl: params.identityReferenceUrl }
        : {})), { identityFingerprint: params.identityFingerprint, identityFingerprintVersion: identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION, frameContinuation: { stage: 'analysis', retryCount: 0, state: 'checkpointed' }, resumeAvailable: true }));
    await assertJobActive(params.userId, params.jobId);
    if (params.request.mode === 'profile') {
        const cached = await loadCharacterAnalysisCache(params.userId, params.request.sourceStoragePath, params.identityFingerprint, 1 + params.additionalReferenceUrls.length, params.request.resourceMode);
        const analysis = (cached === null || cached === void 0 ? void 0 : cached.characterAnalysis) || await (0, director_1.analyzeEmoticonCharacter)({
        ...
        await assertJobActive(params.userId, params.jobId);
        if (!(cached === null || cached === void 0 ? void 0 : cached.characterAnalysis)) {
        ...
        await params.update({
            status: 'completed',
            progress: 100,
            statusMessage: (cached === null || cached === void 0 ? void 0 : cached.characterAnalysis)
                ? '이전에 검증한 동일 참조 세트의 캐릭터 분석을 불러왔어요.'
                : '캐릭터 외형 분석이 완료됐어요. 검토한 뒤 프로젝트에 적용하세요.',
            characterAnalysis: analysis,
            analysisMode: params.request.resourceMode,
            analysisReused: Boolean(cached === null || cached === void 0 ? void 0 : cached.characterAnalysis),
    ...
    const profileJobId = params.request.profileJobId;
    if (profileJobId === params.jobId)
        throw new Error('A sheet plan cannot reference itself.');
    const profileSnapshot = await firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${profileJobId}`).get();
    const profileJob = profileSnapshot.data() || {};
    const analysis = schema_1.emoticonCharacterAnalysisSchema.safeParse(profileJob.characterAnalysis);
    if (!profileSnapshot.exists
        ...
        || profileJob.identityFingerprintVersion !== identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION
    ...
    const requestedCount = params.request.sheetItemCount;
    const sheetPlan = await (0, director_1.planEmoticonCharacterSheet)({
        apiKey: params.apiKey,
        model: params.model,
        fallbackModels: params.fallbackModels,
        characterAnalysis: analysis.data,
        request: params.request.sheetRequest,
...
async function reserveRateLimitSlot(params) {
    const ref = firestore_3.db.doc(`emoticonStudioRateLimits/${params.userId}`);
    const jobRef = firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`);
    ...
    return firestore_3.db.runTransaction(async (transaction) => {
        ...
        if (job.userId !== params.userId)
            throw new Error('The emoticon job owner does not match its path.');
        if (job.status === 'cancelled' || job.cancelRequestedAt) {
            throw new EmoticonJobCancelledError();
        }
        if (job.status === 'completed' || job.status === 'failed') {
        ...
        const existingExecuteAtMs = typeof job.rateLimitExecuteAtMs === 'number'
            ...
            : null;
        const hasLegacyCostReservation = (typeof job.openRouterAuthorizedCostUsd === 'number'
        ...
        const hasPerRequestCostGate = (typeof job.openRouterAuthorizedCostUsd === 'number'
            && Number.isFinite(job.openRouterAuthorizedCostUsd)
            && job.openRouterAuthorizedCostUsd >= 0
        ...
        if (existingExecuteAtMs !== null
            && ((job.costControlVersion === rateLimits_1.EMOTICON_COST_CONTROL_VERSION
                && hasPerRequestCostGate)
                || (job.costControlVersion === rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION
                    && hasLegacyCostReservation))) {
            return {
                executeAtMs: existingExecuteAtMs,
                deferred: existingExecuteAtMs > nowMs + 2000,
            };
        }
        if (job.costControlVersion === rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION) {
        ...
        const allocation = existingExecuteAtMs === null
            ? (0, rateLimits_1.allocateEmoticonRateSlot)({
                nowMs,
                minuteLimit,
                dailyLimit: EMOTICON_DAILY_LIMITS[params.mode],
                state: {
                    minuteBucket: data[`${prefix}ReservationMinuteBucket`],
                    minuteCount: data[`${prefix}ReservationMinuteCount`],
                    dayBucket: data[`${prefix}ReservationDayBucket`],
                    dayCount: data[`${prefix}ReservationDayCount`],
                },
            })
            : null;
        const authorizedCostUsd = (0, rateLimits_1.estimateEmoticonJobAuthorizationUsd)({
            mode: params.mode,
        ...
        const executeAtMs = existingExecuteAtMs !== null && existingExecuteAtMs !== void 0 ? existingExecuteAtMs : allocation.executeAtMs;
        transaction.set(ref, Object.assign(Object.assign({ userId: params.userId }, (allocation ? {
        ...
        } : {})), { dailyCostLimitUsd: EMOTICON_COST_LIMITS.dailyUsd, updatedAt: firestore_1.FieldValue.serverTimestamp() }), { merge: true });
        transaction.update(jobRef, {
            rateLimitExecuteAtMs: executeAtMs,
            rateLimitReservedAt: firestore_1.FieldValue.serverTimestamp(),
            ...
            costControlVersion: rateLimits_1.EMOTICON_COST_CONTROL_VERSION,
            updatedAt: firestore_1.FieldValue.serverTimestamp(),
        });
        return { executeAtMs, deferred: executeAtMs > nowMs + 2000 };
    });
}
const TERMINAL_JOB_STATUSES = new Set(['completed', 'failed', 'cancelled']);
async function settleTerminalJobCostReservation(userId, jobId) {
    const rateLimitRef = firestore_3.db.doc(`emoticonStudioRateLimits/${userId}`);
    const jobRef = firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`);
    await firestore_3.db.runTransaction(async (transaction) => {
        ...
        const dayBucket = Number.isInteger(job.openRouterCostReservationDayBucket)
            ? job.openRouterCostReservationDayBucket
            : null;
        if (job.costControlVersion !== rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION
            ...
            || authorizedUsd <= 0) {
            transaction.update(jobRef, {
                costReservationSettledAt: firestore_1.FieldValue.serverTimestamp(),
                costReservationAccountedUsd: Math.round((actualUsd + inflightUsd) * 10000) / 10000,
                updatedAt: firestore_1.FieldValue.serverTimestamp(),
            });
            return;
        }
        ...
        const existingMap = rateLimit.costReservationsByDay
            ...
            ? rateLimit.costReservationsByDay
            : {
                [String(rateLimit.costReservationDayBucket)]: typeof rateLimit.costReservedUsd === 'number'
                    ? rateLimit.costReservedUsd
                    : 0,
            };
        const reservationsByDay = (0, rateLimits_1.settleEmoticonCostReservation)({
            reservationsByDay: existingMap,
            dayBucket,
            authorizedUsd,
            accountedUsd: actualUsd + inflightUsd,
        });
        transaction.update(rateLimitRef, Object.assign(Object.assign({ costReservationsByDay: reservationsByDay, costReservationVersion: rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION }, (rateLimit.costReservationDayBucket === dayBucket
            ? { costReservedUsd: reservationsByDay[String(dayBucket)] || 0 }
            : {})), { updatedAt: firestore_1.FieldValue.serverTimestamp() }));
        transaction.update(jobRef, {
            costReservationSettledAt: firestore_1.FieldValue.serverTimestamp(),
            costReservationAccountedUsd: Math.round((actualUsd + inflightUsd) * 10000) / 10000,
            costControlVersion: rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION,
            updatedAt: firestore_1.FieldValue.serverTimestamp(),
        });
    });
}
async function deferJobUntilReservedSlot(params) {
    const jobRef = firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`);
    const queueId = (0, node_crypto_1.createHash)('sha256')
        .update(`${params.userId}:${params.jobId}`)
        .digest('hex');
    const queueRef = firestore_3.db.collection('emoticonStudioDeferredJobs').doc(queueId);
    await firestore_3.db.runTransaction(async (transaction) => {
        var _a;
        ...
        if (!queueSnapshot.exists) {
            transaction.create(queueRef, Object.assign(Object.assign(Object.assign(Object.assign({ userId: params.userId, jobId: params.jobId, mode: params.mode, reason }, (params.batchId ? { batchId: params.batchId } : {})), (params.projectId ? { projectId: params.projectId } : {})), (params.projectItemId ? { projectItemId: params.projectItemId } : {})), { status: 'queued', executeAtMs: params.executeAtMs, expiresAt: admin.firestore.Timestamp.fromMillis(params.executeAtMs + CONTINUATION_TTL_MS), createdAt: firestore_1.FieldValue.serverTimestamp(), updatedAt: firestore_1.FieldValue.serverTimestamp() }));
        }
        else if (((_a = queueSnapshot.data()) === null || _a === void 0 ? void 0 : _a.status) === 'queued') {
            transaction.update(queueRef, Object.assign(Object.assign(Object.assign(Object.assign({ reason }, (params.batchId ? { batchId: params.batchId } : {})), (params.projectId ? { projectId: params.projectId } : {})), (params.projectItemId ? { projectItemId: params.projectItemId } : {})), { executeAtMs: params.executeAtMs, expiresAt: admin.firestore.Timestamp.fromMillis(params.executeAtMs + CONTINUATION_TTL_MS), updatedAt: firestore_1.FieldValue.serverTimestamp() }));
        }
        transaction.update(jobRef, {
            status: 'queued',
...
function buildSpecReport(params) {
    var _a, _b;
    const inspections = params.files.reduce((result, file) => {
    ...
    const width = (canonical === null || canonical === void 0 ? void 0 : canonical.width) || params.outputProfile.width;
    const height = (canonical === null || canonical === void 0 ? void 0 : canonical.height) || params.outputProfile.height;
    const frameCount = (canonical === null || canonical === void 0 ? void 0 : canonical.frameCount) || params.plan.action.frameCount;
    const fps = Math.max(1, Math.round((canonical === null || canonical === void 0 ? void 0 : canonical.fps) || params.plan.action.fps));
    const durationMs = (_a = canonical === null || canonical === void 0 ? void 0 : canonical.durationMs) !== null && _a !== void 0 ? _a : params.plan.action.durationMs;
    const loop = (_b = canonical === null || canonical === void 0 ? void 0 : canonical.loop) !== null && _b !== void 0 ? _b : params.outputProfile.type === 'animated';
...
function timestampToMillis(value) {
    ...
    return typeof (timestamp === null || timestamp === void 0 ? void 0 : timestamp.toMillis) === 'function' ? timestamp.toMillis() : Date.now();
}
function continuationExpiresAt() {
    return admin.firestore.Timestamp.fromMillis(Date.now() + CONTINUATION_TTL_MS);
}
async function claimInitialJobRun(userId, jobId) {
    const jobRef = firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`);
    const runToken = (0, node_crypto_1.randomUUID)();
    const nowMs = Date.now();
    return firestore_3.db.runTransaction(async (transaction) => {
        const snapshot = await transaction.get(jobRef);
        if (!snapshot.exists)
        ...
        const legacyClaimedAt = job.generationRunClaimedAt;
        const legacyClaimedAtMs = typeof (legacyClaimedAt === null || legacyClaimedAt === void 0 ? void 0 : legacyClaimedAt.toMillis) === 'function'
        ...
        transaction.update(jobRef, {
            ...
            generationRunClaimedAt: firestore_1.FieldValue.serverTimestamp(),
            generationRunLeaseExpiresAtMs: nowMs + INITIAL_RUN_LEASE_MS,
            generationRunAttemptCount: firestore_1.FieldValue.increment(1),
            updatedAt: firestore_1.FieldValue.serverTimestamp(),
        });
        return runToken;
    });
}
function parseContinuationState(value, frameCount) {
    var _a;
    const parsed = schema_1.emoticonContinuationStateSchema.safeParse(value);
    if (!parsed.success) {
        throw new Error(`The saved continuation state is invalid: ${((_a = parsed.error.issues[0]) === null || _a === void 0 ? void 0 : _a.message) || 'unknown error'}`);
    }
    ...
    return Object.assign(Object.assign(Object.assign({ stage: state.stage, pass: state.pass, startIndex: state.startIndex, nextFrameIndex: state.nextFrameIndex, totalGenerationCalls: state.totalGenerationCalls, retryCount: state.retryCount }, (state.correction ? { correction: state.correction } : {})), (state.repairFrameIndices
...
async function enqueueContinuation(params) {
    ...
    const continuationRef = firestore_3.db.collection('emoticonStudioContinuations').doc(token);
    const jobRef = firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`);
    const persistedState = Object.assign(Object.assign({}, params.continuation), { state: 'queued', token, requestedAt: firestore_1.FieldValue.serverTimestamp() });
    await firestore_3.db.runTransaction(async (transaction) => {
        const snapshot = await transaction.get(jobRef);
        if (!snapshot.exists)
            throw new Error('The emoticon job no longer exists.');
        ...
        transaction.update(jobRef, Object.assign(Object.assign({}, (params.checkpointData || {})), { status: continuationJobStatus(params.continuation.stage), progress: params.progress, statusMessage: params.statusMessage, frameContinuation: persistedState, resumeAvailable: true, updatedAt: firestore_1.FieldValue.serverTimestamp() }));
...
async function ensureContinuationBudget(params) {
    if (!params.deadlineAtMs)
        return;
    if (params.deadlineAtMs - Date.now() >= params.minimumRemainingMs)
        return;
    await scheduleFrameContinuation(params);
}
function isAmbiguousImageGenerationTimeout(error) {
...
function isTransientContinuationError(error) {
    const message = error instanceof Error ? error.message : String(error);
    if (isAmbiguousImageGenerationTimeout(error))
        return false;
    const status = typeof (error === null || error === void 0 ? void 0 : error.status) === 'number'
        ? error.status
        : null;
...
async function retryContinuationAfterTransient(params) {
    if (!isTransientContinuationError(params.error))
        return false;
    const jobRef = firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`);
    ...
    if (job.status === 'completed'
        ...
        || job.cancelRequestedAt)
        return false;
    const plan = schema_1.emoticonStoredPlanSchema.safeParse(job.plan);
    let continuation;
    try {
        continuation = parseContinuationState(job.frameContinuation, plan.success ? plan.data.action.frameCount : undefined);
    }
    catch (_a) {
        return false;
    }
    ...
    if (retryCount >= MAX_CONTINUATION_RETRIES)
        return false;
    const next = Object.assign(Object.assign({}, continuation), { retryCount: retryCount + 1 });
...
function isRenderInfrastructureFailure(error) {
    const message = error instanceof Error ? error.message : String(error);
...
async function buildRenderFailureRecoveryMarker(params) {
    if (!isRenderInfrastructureFailure(params.error))
        return null;
    const snapshot = await firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`).get();
    if (!snapshot.exists)
        return null;
    const job = snapshot.data() || {};
    const continuation = job.frameContinuation && typeof job.frameContinuation === 'object'
        ? job.frameContinuation
        : {};
    if (continuation.stage !== 'static-render' && continuation.stage !== 'render')
        return null;
    const quality = schema_1.emoticonQualitySchema.safeParse(job.quality);
    const plan = schema_1.emoticonStoredPlanSchema.safeParse(job.plan);
    const poseAccepted = quality.success && (plan.success && isDynamicRender(plan.data)
        ? (0, qualityStandards_1.meetsEmoticonDynamicKeyPoseAcceptance)(quality.data)
        : (0, qualityStandards_1.meetsEmoticonPoseAcceptance)(quality.data));
    if (!poseAccepted)
        return null;
    return {
        stage: 'render',
...
async function uploadBuffer(params) {
    ...
    const existingMetadata = params.preserveExistingDownloadToken
        ? await storageFile.getMetadata()
            ...
            .catch(() => null)
        : null;
    const existingDownloadToken = typeof ((_a = existingMetadata === null || existingMetadata === void 0 ? void 0 : existingMetadata.metadata) === null || _a === void 0 ? void 0 : _a.firebaseStorageDownloadTokens) === 'string'
        ? (_b = existingMetadata.metadata.firebaseStorageDownloadTokens.split(',')[0]) === null || _b === void 0 ? void 0 : _b.trim()
        : '';
    const downloadToken = existingDownloadToken || (0, node_crypto_1.randomUUID)();
...
async function prepareCanonicalSource(params) {
    ...
    return {
        asset,
        fingerprint: (0, node_crypto_1.createHash)('sha256').update(normalized).digest('hex'),
    };
}
...
function readCanonicalReferenceCheckpoint(params) {
    const referenceCount = [...new Set(params.references
            .map((reference) => reference.sourceStoragePath)
            .filter((storagePath) => storagePath !== params.sourceStoragePath))].slice(0, 3).length;
    ...
    if (referenceCount >= 2
        ...
        return null;
    return Object.assign(Object.assign({ urls: storedUrls }, (referenceCount >= 2 ? { identitySheetUrl: identitySheetUrl } : {})), { referenceSetFingerprint: fingerprint });
}
async function prepareCanonicalReferenceSet(params) {
    var _a;
    const expectedSourcePrefix = `users/${params.userId}/emoticon-studio/sources/`;
    const uniqueStoragePaths = [...new Set(params.references
            .map((reference) => reference.sourceStoragePath)
            .filter((storagePath) => storagePath !== params.sourceStoragePath))].sort((left, right) => left.localeCompare(right)).slice(0, 3);
    const canonicalUrls = [];
    ...
    for (const [index, storagePath] of uniqueStoragePaths.entries()) {
        ...
        normalizedFingerprints.push((0, node_crypto_1.createHash)('sha256').update(normalized).digest('hex'));
    ...
    return Object.assign(Object.assign({ urls: canonicalUrls }, (identitySheetUrl ? { identitySheetUrl } : {})), { referenceSetFingerprint: (0, identityFingerprint_1.buildEmoticonReferenceSetFingerprint)(normalizedFingerprints) });
}
...
async function uploadRenderedFiles(params) {
    const outputs = {};
    const uploadedFiles = await mapWithConcurrency(params.files, EMOTICON_UPLOAD_CONCURRENCY, async (file) => ({
        file,
    ...
    for (const { file, uploaded } of uploadedFiles) {
        outputs[file.format] = Object.assign(Object.assign({}, uploaded), { format: file.format, inspection: file.inspection });
    }
    return outputs;
}
async function uploadCompositedFrameSequence(params) {
    const uploaded = await mapWithConcurrency(params.frames, EMOTICON_UPLOAD_CONCURRENCY, async (buffer, index) => {
        const asset = await uploadBuffer({
            userId: params.userId,
            jobId: params.jobId,
...
function assertRenderedFilesPassedInspection(files) {
    if (files.length && files.every((file) => file.inspection.passed))
        return;
    const issues = files.flatMap((file) => file.inspection.issues).slice(0, 4);
    throw new Error(`One or more encoded output inspections failed${issues.length ? `: ${issues.join('; ')}` : '.'}`);
}
...
function motionReviewScore(review) {
    return (0, qualityStandards_1.scoreEmoticonMotionQuality)(review);
}
function buildPremiumMotionCorrection(review) {
    const deficits = (0, qualityStandards_1.getEmoticonPremiumMotionDeficits)(review);
    return [
        `Target an expert-quality ${qualityStandards_1.EMOTICON_PREMIUM_MOTION_TARGET}/100 animation, not merely the minimum acceptance threshold.`,
...
function needsPoseIsolationCorrection(quality, dynamicKeyPose = false) {
    return dynamicKeyPose
        ? !(0, qualityStandards_1.meetsEmoticonDynamicKeyPoseAcceptance)(quality)
        : !(0, qualityStandards_1.meetsEmoticonPoseAcceptance)(quality);
}
...
function applyAlphaIsolationEvidence(quality, inspection) {
    ...
    return Object.assign(Object.assign({}, quality), { backgroundClean: 100, issues: quality.issues.filter((issue) => !HIDDEN_ALPHA_ISSUE_PATTERN.test(issue)) });
}
function applyMotionAlphaIsolationEvidence(review, inspections) {
    if (!inspections.length || inspections.some((inspection) => !inspection.passed))
        return review;
    const backgroundIssues = review.issues.filter((issue) => BACKGROUND_ISSUE_PATTERN.test(issue));
    if (!backgroundIssues.length || backgroundIssues.some((issue) => !HIDDEN_ALPHA_ISSUE_PATTERN.test(issue))) {
        return review;
    }
    return Object.assign(Object.assign({}, review), { backgroundClean: 100, issues: review.issues.filter((issue) => !HIDDEN_ALPHA_ISSUE_PATTERN.test(issue)) });
}
function safeErrorMessage(error) {
    const message = error instanceof Error ? error.message : String(error);
    if ((0, imageGeneration_1.isDefiniteImageRouteCompatibilityError)(error)) {
...
async function syncLinkedProjectItem(params) {
    if (!params.request.projectId || !params.request.projectItemId)
        return;
    const projectRef = firestore_3.db.doc(`users/${params.userId}/emoticonProjects/${params.request.projectId}`);
    ...
    await firestore_3.db.runTransaction(async (transaction) => {
        ...
        const currentProjectRevision = typeof project.revision === 'number'
            ? project.revision
            : 0;
        const projectConfigurationChanged = (params.generationStatus === 'completed'
        ...
        const embeddedItem = items.find((value) => (Boolean(value && typeof value === 'object')
            && value.id === params.request.projectItemId));
        ...
        const synchronizedMotion = params.authoritativeMotion
            ? Object.assign(Object.assign({}, currentMotion), params.authoritativeMotion) : undefined;
        const synchronizedEditRecipe = effectiveGenerationStatus === 'completed'
            ? ((_a = params.request.renderOverrides) === null || _a === void 0 ? void 0 : _a.editRecipe)
                || (params.request.mode === 'generate'
                    ? (0, schema_1.createIdentityEmoticonImageEditRecipe)()
                    : undefined)
            : undefined;
        const currentEditHistory = Array.isArray(current.editHistory)
            ? current.editHistory.filter((entry) => (Boolean(entry && typeof entry === 'object')
                && entry.resultJobId !== params.jobId))
            : [];
        ...
        if (!itemSnapshot.exists && embeddedItem) {
            Object.keys(embeddedItem).forEach((key) => {
                if (embeddedItem[key] !== undefined)
                    baseItem[key] = embeddedItem[key];
            });
        }
        transaction.set(itemRef, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, baseItem), { id: params.request.projectItemId, jobId: projectConfigurationChanged ? null : params.jobId, activeJobCreatedAtMs: incomingJobCreatedAtMs, generationStatus: effectiveGenerationStatus, validationErrors: effectiveValidationErrors }), (!projectConfigurationChanged && synchronizedMotion ? { motion: synchronizedMotion } : {})), (!projectConfigurationChanged && synchronizedEditRecipe ? {
            editRecipe: synchronizedEditRecipe,
            editHistory: synchronizedEditHistory,
        } : {})), { serverRevision }), (incomingClientRevision !== undefined ? { clientRevision: incomingClientRevision } : {})), (params.request.projectRevision !== undefined
            ? { sourceProjectRevision: params.request.projectRevision }
            : {})), (!itemSnapshot.exists ? { createdAt: firestore_1.FieldValue.serverTimestamp() } : {})), { updatedAt: firestore_1.FieldValue.serverTimestamp() }), { merge: true });
        let itemFound = false;
        const nextItems = items.map((value) => {
            if (!value || typeof value !== 'object')
                return value;
            const item = value;
            if (item.id !== params.request.projectItemId)
                return value;
            itemFound = true;
            return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, item), { jobId: projectConfigurationChanged ? null : params.jobId, activeJobCreatedAtMs: incomingJobCreatedAtMs, generationStatus: effectiveGenerationStatus, validationErrors: effectiveValidationErrors }), (!projectConfigurationChanged && synchronizedMotion ? { motion: synchronizedMotion } : {})), (!projectConfigurationChanged && synchronizedEditRecipe ? {
                editRecipe: synchronizedEditRecipe,
                editHistory: synchronizedEditHistory,
            } : {})), { serverRevision }), (incomingClientRevision !== undefined ? { clientRevision: incomingClientRevision } : {}));
        });
            ...
            : statuses.some((status) => status === 'generating' || status === 'queued')
                ...
                : statuses.some((status) => status === 'failed')
                    ...
                    : statuses.some((status) => status === 'cancelled')
                        ? 'ready'
                        : 'ready';
        transaction.update(projectRef, Object.assign(Object.assign({}, (itemFound ? { items: nextItems } : {})), { status: projectStatus, lastItemJobId: params.jobId, lastItemStatus: effectiveGenerationStatus, updatedAt: firestore_1.FieldValue.serverTimestamp() }));
...
async function syncCompletedProjectItemNonFatal(params) {
    try {
        const jobSnapshot = await firestore_3.db.doc(`users/${params.userId}/emoticonJobs/${params.jobId}`).get();
        const completedJob = jobSnapshot.data() || {};
        const completedPlan = schema_1.emoticonStoredPlanSchema.safeParse(completedJob.plan);
        const completedManualReport = schema_1.emoticonManualFrameImportReportSchema.safeParse(completedJob.manualImportReport);
        const completedOutputProfile = schema_1.emoticonOutputProfileSchema.safeParse(completedJob.outputProfile);
        const completedSpec = completedJob.specReport && typeof completedJob.specReport === 'object'
            ? completedJob.specReport
            : {};
        const inspectedMotion = (Number.isInteger(completedSpec.fps)
            && Number.isInteger(completedSpec.frameCount)
            && Number.isInteger(completedSpec.durationMs))
            ? {
                fps: completedSpec.fps,
                frameCount: completedSpec.frameCount,
                durationMs: completedSpec.durationMs,
            }
            : undefined;
        const authoritativeMotion = completedOutputProfile.success
            ...
            : completedManualReport.success && completedPlan.success
                ...
                : inspectedMotion || (completedPlan.success
                    ...
                    : undefined);
        await syncLinkedProjectItem(Object.assign(Object.assign({}, params), { generationStatus: 'completed', authoritativeMotion }));
    }
    catch (error) {
...
async function reviewPose(params) {
    try {
        ...
        if (isTransientContinuationError(error))
            throw error;
...
function isVerifiedBodyMotion(review, plan) {
    return (0, qualityStandards_1.meetsEmoticonMotionAcceptance)(review, (0, qualityStandards_1.getEmoticonMotionAcceptanceRequirements)(plan));
}
...
function buildAnimationFrameSeed(sequenceSeed, frameIndex) {
...
async function renderAiFrameSequenceOutputs(params) {
    ...
    if (!mirroredPoseUrl) {
        ...
        if (!params.poseBuffer && !((_a = params.poseStoragePath) === null || _a === void 0 ? void 0 : _a.startsWith(expectedPosePrefix))) {
        ...
        const canonicalPoseBuffer = params.poseBuffer
            || await downloadStoredPose(params.poseStoragePath);
    ...
    const frameBuffers = new Array(animationFrames.length).fill(undefined);
    const frameUrls = animationFrames.map((frame) => frame.url);
    const ensureFrameBuffersHydrated = async () => {
        const missingIndices = frameBuffers.reduce((indices, buffer, index) => {
            if (!buffer)
                indices.push(index);
            return indices;
        }, []);
        ...
        const hydrated = frameBuffers.filter((buffer) => buffer !== undefined);
    ...
    if (!frameSequence) {
        ...
        await assertJobActive(params.userId, params.jobId);
        frameSequence = await (0, director_1.planEmoticonFrameSequence)({
            apiKey: params.apiKey,
            model: params.model,
            fallbackModels: params.fallbackModels,
            sourceImageUrl: params.sourceImageUrl,
        ...
        await params.update({
            ...
            frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
    ...
    const generateFrames = async (paramsForPass) => {
        ...
        continuation = Object.assign({ stage: 'generation', pass,
            startIndex,
            nextFrameIndex, totalGenerationCalls: continuation.totalGenerationCalls, retryCount: continuation.retryCount || 0 }, (correction ? { correction } : {}));
        await params.update({
            animationFrames,
            frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
            resumeAvailable: true,
        ...
        for (let frameIndex = nextFrameIndex; frameIndex < frameCount; frameIndex += 1) {
            ...
            animationFrames.push(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, asset), { contentType: 'image/png', generationModel: generated.model }), (generated.provider ? { generationProvider: generated.provider } : {})), { generationRequestId: generated.requestId, generationSeed: frameSeed }), (generated.costUsd !== undefined ? { generationCostUsd: generated.costUsd } : {})));
            ...
            await params.update({
                ...
                animationFrames,
                frameGeneration: Object.assign({ strategy: 'openrouter-image-sequence', requestedFrameCount: frameCount, generatedFrameCount: animationFrames.length, totalGenerationCalls: continuation.totalGenerationCalls, repairPasses: pass - 1 }, (pass === 2 ? { repairStartIndex: startIndex } : {})),
                frameContinuation: Object.assign(Object.assign({}, continuation), { stage: 'generation', nextFrameIndex: frameIndex + 1, state: 'checkpointed' }),
                resumeAvailable: frameIndex + 1 < frameCount,
            });
            continuation.nextFrameIndex = frameIndex + 1;
        }
        continuation = Object.assign(Object.assign({}, continuation), { stage: 'review', nextFrameIndex: frameCount });
        await params.update({
            frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
            resumeAvailable: true,
        });
    ...
    const generateSpriteSheetFrames = async () => {
        const layout = (0, animationContainer_1.resolveEmoticonSpriteSheetLayout)(frameCount);
        await ensureContinuationBudget({
            deadlineAtMs: params.deadlineAtMs,
            minimumRemainingMs: MIN_IMAGE_CALL_BUDGET_MS,
            userId: params.userId,
        ...
        await assertJobActive(params.userId, params.jobId);
        const generated = await (0, imageGeneration_1.generateEmoticonSpriteSheet)({
            apiKey: params.apiKey,
            preferredModel: params.imageModel,
            sourceImageUrl: params.sourceImageUrl,
            originalUserInstruction: params.originalUserInstruction,
        ...
        try {
            ...
            await params.update({
                spriteSheetGeneration: {
                    strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY,
                    state: 'rejected',
        ...
        await params.update({
            spriteSheetGeneration: Object.assign(Object.assign(Object.assign({ strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY, state: 'extracting', columns: layout.columns, rows: layout.rows, frameCount: layout.frameCount, storagePath: sheetAsset.storagePath, url: sheetAsset.url, model: generated.model }, (generated.provider ? { provider: generated.provider } : {})), { requestId: generated.requestId }), (generated.costUsd !== undefined ? { costUsd: generated.costUsd } : {})),
            frameGeneration: {
                strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY,
                requestedFrameCount: frameCount,
        ...
        try {
            const extracted = await (0, animationContainer_1.extractEmoticonSpriteSheetFrames)(spriteSheetBuffer, layout);
            const [variation, alphaInspections] = await Promise.all([
                (0, renderer_1.evaluateEmoticonFrameVariation)(extracted.frames, {
                    requireSilhouetteVariation: (0, qualityStandards_1.getEmoticonMotionAcceptanceRequirements)(params.plan)
                        .requireLimbMotion,
                }),
                Promise.all(extracted.frames.map((frame) => (0, renderer_1.inspectEmoticonAlphaIsolation)(frame))),
            ]);
            if (!variation.passes || alphaInspections.some((inspection) => !inspection.passed)) {
                throw new Error(!variation.passes
                    ? 'The sheet repeats one pose or changes only the camera.'
                    : 'One or more sheet cells do not have a clean isolated background.');
            }
            const uploadedFrames = await Promise.all(extracted.frames.map((buffer, frameIndex) => (uploadBuffer({
                userId: params.userId,
                jobId: params.jobId,
            ...
            extracted.frames.forEach((buffer, frameIndex) => {
                ...
                frameBuffers.push(buffer);
                frameUrls.push(asset.url);
                animationFrames.push(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, asset), { contentType: 'image/png', generationModel: generated.model }), (generated.provider ? { generationProvider: generated.provider } : {})), { generationRequestId: generated.requestId, generationSeed: sequenceSeed }), (frameIndex === 0 && generated.costUsd !== undefined
                    ? { generationCostUsd: generated.costUsd }
                    : {})));
            });
            continuation = Object.assign(Object.assign({}, continuation), { stage: 'review', pass: 1, startIndex: 0, nextFrameIndex: frameCount });
            await params.update({
                status: 'validating',
                progress: 78,
                statusMessage: `${layout.columns}×${layout.rows} 시트에서 ${frameCount}개의 실제 포즈를 분리했어요. 움직임을 확인하고 있어요.`,
                animationFrames,
                spriteSheetGeneration: Object.assign(Object.assign(Object.assign(Object.assign({ strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY, state: 'extracted', columns: layout.columns, rows: layout.rows, frameCount: layout.frameCount, storagePath: sheetAsset.storagePath, url: sheetAsset.url, model: generated.model }, (generated.provider ? { provider: generated.provider } : {})), { requestId: generated.requestId }), (generated.costUsd !== undefined ? { costUsd: generated.costUsd } : {})), { evidence: extracted.evidence, deterministicMotion: variation }),
                frameGeneration: {
                    strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY,
                    requestedFrameCount: frameCount,
                    generatedFrameCount: animationFrames.length,
            ...
            await params.update({
                ...
                spriteSheetGeneration: Object.assign(Object.assign({ strategy: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY, state: 'rejected', columns: layout.columns, rows: layout.rows, frameCount: layout.frameCount, storagePath: sheetAsset.storagePath, url: sheetAsset.url, model: generated.model }, (generated.provider ? { provider: generated.provider } : {})), { requestId: generated.requestId, reason: error instanceof Error ? error.message.slice(0, 400) : 'local-quality-gate-failed' }),
            });
            return false;
        }
    };
    const repairSelectedFrames = async () => {
        ...
        for (; repairCursor < repairFrameIndices.length; repairCursor += 1) {
            ...
            animationFrames[frameIndex] = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, asset), { contentType: 'image/png', generationModel: generated.model }), (generated.provider ? { generationProvider: generated.provider } : {})), { generationRequestId: generated.requestId, generationSeed: frameSeed }), (generated.costUsd !== undefined ? { generationCostUsd: generated.costUsd } : {}));
            continuation = Object.assign(Object.assign({}, continuation), { nextRepairCursor: repairCursor + 1 });
            await params.update({
                status: 'animating',
                progress: 82 + repairCursor,
    ...
    if (continuation.stage === 'generation') {
        if (continuation.pass === 2 && ((_b = continuation.repairFrameIndices) === null || _b === void 0 ? void 0 : _b.length)) {
    ...
    const reviewFrames = async (reviewPass) => {
        ...
        const [localVariation, alphaInspections] = await Promise.all([
            (0, renderer_1.evaluateEmoticonFrameVariation)(hydratedFrameBuffers, {
                requireSilhouetteVariation: (0, qualityStandards_1.getEmoticonMotionAcceptanceRequirements)(params.plan)
                    .requireLimbMotion,
            }),
            Promise.all(hydratedFrameBuffers.map((frameBuffer) => (0, renderer_1.inspectEmoticonAlphaIsolation)(frameBuffer))),
        ]);
        ...
        const alphaProblemFrameIndices = alphaInspections.flatMap((inspection, index) => (inspection.passed ? [] : [index]));
        ...
        const review = await reviewImageFrameSequence({
            ...
            additionalReferenceUrls: params.resourceMode === 'efficient'
                ? efficientIdentityReviewReferences(params.identityReferenceUrl, params.additionalReferenceUrls)
    ...
    const selectiveRepairIndices = (validProblemIndices.length > 0
        && validProblemIndices.length <= 2
        && !review.cameraOnly) ? validProblemIndices : [];
    ...
    const shouldAutoRepair = continuation.pass === 1 && (params.resourceMode === 'premium'
        ? !(0, qualityStandards_1.meetsEmoticonPremiumMotionTarget)(review)
    ...
    if (shouldAutoRepair) {
        ...
        if (params.resourceMode !== 'premium' && !firstPassUsesSpriteSheet) {
            ...
            await params.update({
                status: 'animating',
                progress: 81,
                statusMessage: `${qualityStandards_1.EMOTICON_PREMIUM_MOTION_TARGET}점 목표로 ${repairStartIndex + 1}번 프레임부터 정밀 보정할게요.`,
                motionReview: review,
                animationFrames,
                frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
                resumeAvailable: true,
            ...
            await params.update({
                frameGeneration: Object.assign({ strategy: 'openrouter-image-sequence', requestedFrameCount: frameCount, generatedFrameCount: frameUrls.length, totalGenerationCalls: continuation.totalGenerationCalls, repairPasses: 1, repairStartIndex: fullRepairStartIndex }, (firstPassUsesSpriteSheet
                    ? { fallbackFrom: animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY }
                    : {})),
                animationFrames,
            });
        }
        ...
        const shouldKeepFirstPass = (firstPassVerified && !repairedPassVerified) || (firstPassVerified === repairedPassVerified
        ...
        if (shouldKeepFirstPass) {
            ...
            await params.update({
                animationFrames,
                motionReview: review,
                frameGeneration: Object.assign(Object.assign({ strategy: firstPassUsesSpriteSheet
                        ? animationContainer_1.EMOTICON_SPRITE_SHEET_STRATEGY
                        : params.resourceMode !== 'premium'
                            ? 'openrouter-selective-frame-repair'
                            : 'openrouter-image-sequence', requestedFrameCount: frameCount, generatedFrameCount: frameUrls.length, totalGenerationCalls: continuation.totalGenerationCalls, repairPasses: 1 }, (params.resourceMode !== 'premium' && !firstPassUsesSpriteSheet
                    ? { repairedFrameIndices: selectiveRepairIndices }
                    : { repairStartIndex })), { selectedPass: 1, repairDiscardedBecauseWorse: true }),
            });
        }
        else {
    ...
    continuation = Object.assign(Object.assign({}, continuation), { stage: 'render', nextFrameIndex: frameCount });
    await params.update({
        motionReview: review,
        premiumQualityTarget: qualityStandards_1.EMOTICON_PREMIUM_MOTION_TARGET,
        premiumQualityScore: motionReviewScore(review),
        premiumQualityAchieved: (0, qualityStandards_1.meetsEmoticonPremiumMotionTarget)(review),
        frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
        resumeAvailable: true,
        status: 'rendering',
        progress: 88,
...
async function renderEfficientCompositeJob(params) {
    ...
    const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(params.request.outputProfile);
    const plan = (0, quickComposite_1.buildEfficientCompositePlan)({
    ...
    await params.update({
        ...
        plan,
        outputProfile,
        motionFallbackReason: quickComposite_1.EFFICIENT_LOCAL_COMPOSITE_VERSION,
    ...
    await assertJobActive(params.userId, params.jobId);
    let compositedFrames = [];
    const safeEditRecipe = ((_a = params.request.renderOverrides) === null || _a === void 0 ? void 0 : _a.editRecipe) || Object.assign(Object.assign({}, (0, schema_1.createIdentityEmoticonImageEditRecipe)()), { scale: 0.82, transparentPadding: 0.1 });
...
function buildManualImportPlan(request) {
    var _a, _b;
    ...
    const bubble = ((_a = request.renderOverrides) === null || _a === void 0 ? void 0 : _a.bubble) || request.bubbleOverride || Object.assign(Object.assign({ text: '', style: 'none', position: 'top', entrance: 'none', font: 'clean' }, schema_1.EMOTICON_BUBBLE_APPEARANCE_DEFAULTS), { timeline: { mode: 'full', startFrame: 0, endFrame: null, cues: [] } });
    return Object.assign({ plan: {
            ...
            bubble,
            bubbleLayers: ((_b = request.renderOverrides) === null || _b === void 0 ? void 0 : _b.bubbleLayers) || request.bubbleLayersOverride || [],
            suggestedPresets: [],
        } }, (frameDurationsMs ? { frameDurationsMs } : {}));
}
async function renderImportedFramesJob(params) {
    var _a;
    if (params.request.mode !== 'import_frames'
    ...
    await assertJobActive(params.userId, params.jobId);
    const sourceFrames = await (0, manualFrameImport_1.downloadVerifiedEmoticonImportFrames)({
        uid: params.userId,
        projectId: params.request.projectId,
        projectItemId: params.request.projectItemId,
    ...
    await assertJobActive(params.userId, params.jobId);
    let compositedFrames = [];
    const files = await (0, renderer_1.renderImageSequenceEmoticon)(Object.assign(Object.assign({ frameBuffers: sourceFrames, plan, formats: params.request.formats, outputProfile, editRecipe: (_a = params.request.renderOverrides) === null || _a === void 0 ? void 0 : _a.editRecipe }, (frameDurationsMs ? { frameDurationsMs } : {})), { onComposedFrames: async (frames) => {
            compositedFrames = await uploadCompositedFrameSequence({
                userId: params.userId,
                jobId: params.jobId,
                frames,
...
function storedOutputsPassedTechnicalInspection(parent) {
    ...
    const storedFormats = Array.isArray(parent.formats)
        ? parent.formats.filter((format) => typeof format === 'string')
        : [];
...
function verifyReusableManualParent(params) {
    const report = schema_1.emoticonManualFrameImportReportSchema.safeParse(params.parent.manualImportReport);
    if (!report.success)
        return null;
    const plan = schema_1.emoticonManualStoredPlanSchema.safeParse(params.parent.plan);
    const frames = schema_1.emoticonAnimationFrameSchema.array().min(1).max(24).safeParse(params.parent.animationFrames);
    const outputProfile = schema_1.emoticonOutputProfileSchema.safeParse(params.parent.outputProfile);
    const specReport = params.parent.specReport && typeof params.parent.specReport === 'object'
        ? params.parent.specReport
        : {};
    if (params.parent.userId !== params.userId
    ...
    if (frames.data.length !== frameCount
    ...
    return Object.assign({ plan: plan.data, animationFrames: frames.data }, (report.data.timingMode === 'per_frame'
        ? { frameDurationsMs: report.data.frameDurationsMs }
        : {}));
}
function applyRerenderTiming(plan, frameDurationsMs) {
    if (!frameDurationsMs || frameDurationsMs.length !== plan.action.frameCount)
        return plan;
    const durationMs = frameDurationsMs.reduce((sum, duration) => sum + duration, 0);
    return Object.assign(Object.assign({}, plan), { action: Object.assign(Object.assign({}, plan.action), { durationMs, fps: Math.max(1, Math.min(30, Math.round((plan.action.frameCount * 1000) / durationMs))) }) });
}
async function rerenderExistingJob(params) {
    ...
    const parentReferences = schema_1.emoticonReferenceImageSchema.array().max(3).safeParse(parent.referenceImages || []);
    ...
    const isEfficientLocalParent = parent.status === 'completed'
        ...
        && parent.motionFallbackReason === quickComposite_1.EFFICIENT_LOCAL_COMPOSITE_VERSION
        && storedOutputsPassedTechnicalInspection(parent);
    const editRecipe = ((_a = params.request.renderOverrides) === null || _a === void 0 ? void 0 : _a.editRecipe) || (isEfficientLocalParent
        ? Object.assign(Object.assign({}, (0, schema_1.createIdentityEmoticonImageEditRecipe)()), { scale: 0.82, transparentPadding: 0.1 }) : undefined);
    ...
    const parentOutputProfile = schema_1.emoticonOutputProfileSchema.safeParse(parent.outputProfile);
    const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(((_b = params.request.renderOverrides) === null || _b === void 0 ? void 0 : _b.outputProfile)
        || params.request.outputProfile
        || (parentOutputProfile.success ? parentOutputProfile.data : undefined));
    if (reusableManualParent) {
        const frameDurationsMs = ((_c = params.request.renderOverrides) === null || _c === void 0 ? void 0 : _c.frameDurationsMs)
            || reusableManualParent.frameDurationsMs;
        const plan = applyRerenderTiming(Object.assign(Object.assign({}, reusableManualParent.plan), { bubble: ((_d = params.request.renderOverrides) === null || _d === void 0 ? void 0 : _d.bubble) || reusableManualParent.plan.bubble, bubbleLayers: ((_e = params.request.renderOverrides) === null || _e === void 0 ? void 0 : _e.bubbleLayers) || reusableManualParent.plan.bubbleLayers }), frameDurationsMs);
        await params.update({
            status: 'rendering',
            progress: 35,
        ...
        const animationFrames = await Promise.all(frameBuffers.map(async (buffer, index) => {
            ...
            return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, asset), { contentType: 'image/png' }), (original.generationModel ? { generationModel: original.generationModel } : {})), (original.generationProvider ? { generationProvider: original.generationProvider } : {})), (original.generationRequestId ? { generationRequestId: original.generationRequestId } : {})), (original.generationSeed !== undefined ? { generationSeed: original.generationSeed } : {})), (original.generationCostUsd !== undefined ? { generationCostUsd: original.generationCostUsd } : {}));
        }));
        await params.update({
            status: 'rendering',
            progress: 55,
        ...
        let compositedFrames = [];
        const files = await (0, renderer_1.renderImageSequenceEmoticon)(Object.assign(Object.assign(Object.assign({ frameBuffers,
            plan, formats: params.request.formats, outputProfile,
            editRecipe }, (frameDurationsMs ? { frameDurationsMs } : {})), (((_f = params.request.renderOverrides) === null || _f === void 0 ? void 0 : _f.frameTransitions)
        ...
        const parentReport = schema_1.emoticonManualFrameImportReportSchema.parse(parent.manualImportReport);
        await params.update(Object.assign(Object.assign({ status: 'completed', progress: 100, statusMessage: editRecipe ? '수동 프레임 편집본이 완성됐어요.' : '수동 프레임 말풍선 수정본이 완성됐어요.', plan, sourceImageUrl: parent.sourceImageUrl, sourceStoragePath: parent.sourceStoragePath, keyPoseUrl: animationFrames[0].url, keyPoseStoragePath: animationFrames[0].storagePath, animationFrames,
            compositedFrames }, (editRecipe ? { editRecipe } : {})), { outputs,
            outputProfile, specReport: buildSpecReport({ plan, outputProfile, files }), manualImportReport: frameDurationsMs ? Object.assign(Object.assign({}, parentReport), { timingMode: 'per_frame', frameDurationsMs }) : parentReport, analysisReused: true, motionFallbackReason: null, completedAt: firestore_1.FieldValue.serverTimestamp() }));
        return;
    }
    const parentPlan = schema_1.emoticonStoredPlanSchema.safeParse(parent.plan);
    if (!parentPlan.success)
        throw new Error('The original animation plan is unavailable.');
    const motionOverride = ((_g = params.request.renderOverrides) === null || _g === void 0 ? void 0 : _g.motion) || params.request.motionOverride;
    const overriddenParentPlan = (0, outputPlanPolicy_1.normalizeEmoticonPlanForOutputProfile)((0, director_1.applyEmoticonMotionOverride)(parentPlan.data, motionOverride), outputProfile);
    ...
    const verifiedDynamicParent = isDynamicParent
        ? (0, verifiedDynamicParent_1.verifyReusableDynamicParent)({
            parent,
    ...
    if (verifiedDynamicParent && !verifiedDynamicParent.success) {
        throw new Error(`The parent animation is not eligible for safe frame reuse (${verifiedDynamicParent.reason}). `
    ...
    if (!isDynamicParent && !isEfficientLocalParent) {
        const parentPoseQuality = schema_1.emoticonQualitySchema.safeParse(parent.quality);
        const renderFailureRecovery = schema_1.emoticonRenderFailureRecoverySchema.safeParse(parent.renderFailureRecovery);
        const reusablePose = parentPoseQuality.success && (0, qualityStandards_1.meetsEmoticonPoseAcceptance)(parentPoseQuality.data);
        if (!reusablePose && !renderFailureRecovery.success) {
            throw new Error('The parent key pose did not pass identity and isolation review. '
                + 'Create a new AI generation instead of rerendering the rejected pose.');
        }
    }
    const storedAnimationFrames = (verifiedDynamicParent === null || verifiedDynamicParent === void 0 ? void 0 : verifiedDynamicParent.success)
    ...
    if (isDynamicParent && storedAnimationFrames && (verifiedDynamicParent === null || verifiedDynamicParent === void 0 ? void 0 : verifiedDynamicParent.success)) {
        const frameDurationsMs = (_h = params.request.renderOverrides) === null || _h === void 0 ? void 0 : _h.frameDurationsMs;
        const plan = applyRerenderTiming(Object.assign(Object.assign({}, overriddenParentPlan), { bubble: ((_j = params.request.renderOverrides) === null || _j === void 0 ? void 0 : _j.bubble) || parentPlan.data.bubble, bubbleLayers: ((_k = params.request.renderOverrides) === null || _k === void 0 ? void 0 : _k.bubbleLayers) || parentPlan.data.bubbleLayers }), frameDurationsMs);
        const frameBuffers = await downloadStoredAnimationFrames({
            userId: params.userId,
            parentJobId: params.request.parentJobId,
        ...
        const files = await (0, renderer_1.renderImageSequenceEmoticon)(Object.assign(Object.assign(Object.assign({ frameBuffers,
            plan, formats: params.request.formats, outputProfile,
            editRecipe }, (frameDurationsMs ? { frameDurationsMs } : {})), (((_l = params.request.renderOverrides) === null || _l === void 0 ? void 0 : _l.frameTransitions)
            ? { frameTransitions: params.request.renderOverrides.frameTransitions }
            : {})), { onComposedFrames: async (frames) => {
                compositedFrames = await uploadCompositedFrameSequence({
                    userId: params.userId,
        ...
        await params.update(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ status: 'completed', progress: 100, statusMessage: editRecipe
                ? '이미지 편집본이 완성되었어요.'
                : frameDurationsMs || ((_m = params.request.renderOverrides) === null || _m === void 0 ? void 0 : _m.frameTransitions)
                    ? '시간과 전환 효과를 적용한 움짤이 완성되었어요.'
                    : '말풍선 수정본이 완성되었어요.', plan }, (parent.quality ? { quality: parent.quality } : {})), { sourceImageUrl: parent.sourceImageUrl, sourceStoragePath: parent.sourceStoragePath }), (parent.sourceCanonicalStoragePath
            ? { sourceCanonicalStoragePath: parent.sourceCanonicalStoragePath }
            : {})), (parent.sourceFingerprint ? { sourceFingerprint: parent.sourceFingerprint } : {})), (parent.referenceSetFingerprint
            ? { referenceSetFingerprint: parent.referenceSetFingerprint }
            : {})), (parent.identityFingerprint ? { identityFingerprint: parent.identityFingerprint } : {})), (parent.identityFingerprintVersion
            ? { identityFingerprintVersion: parent.identityFingerprintVersion }
            : {})), { keyPoseUrl: parent.keyPoseUrl, keyPoseStoragePath: poseStoragePath, frameSequencePlan: verifiedDynamicParent.frameSequence, motionReview: verifiedDynamicParent.motionReview, animationFrames,
            compositedFrames }), (editRecipe ? { editRecipe } : {})), { outputs,
            outputProfile, specReport: buildSpecReport({ plan, outputProfile, files }), analysisReused: true, motionFallbackReason: null, completedAt: firestore_1.FieldValue.serverTimestamp() }));
        return;
    }
    const poseBuffer = await downloadStoredPose(poseStoragePath);
    const plan = (0, outputPlanPolicy_1.normalizeEmoticonPlanForOutputProfile)((0, director_1.applyEmoticonMotionOverride)(Object.assign(Object.assign({}, overriddenParentPlan), { action: Object.assign(Object.assign({}, overriddenParentPlan.action), { renderMode: 'keyframes', motionType: !isEfficientLocalParent && overriddenParentPlan.action.motionType === 'dynamic'
                ? 'bob'
                : overriddenParentPlan.action.motionType }), bubble: ((_o = params.request.renderOverrides) === null || _o === void 0 ? void 0 : _o.bubble) || parentPlan.data.bubble, bubbleLayers: ((_p = params.request.renderOverrides) === null || _p === void 0 ? void 0 : _p.bubbleLayers) || parentPlan.data.bubbleLayers }), motionOverride), outputProfile);
    await params.update({
        status: 'rendering',
        progress: 55,
    ...
    await params.update(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ status: 'completed', progress: 100, statusMessage: editRecipe ? '이미지 편집본이 완성됐어요.' : '말풍선 수정본이 완성됐어요.', plan }, (parent.quality ? { quality: parent.quality } : {})), { sourceImageUrl: parent.sourceImageUrl, sourceStoragePath: parent.sourceStoragePath }), (parent.sourceCanonicalStoragePath
        ? { sourceCanonicalStoragePath: parent.sourceCanonicalStoragePath }
        : {})), (parent.sourceFingerprint ? { sourceFingerprint: parent.sourceFingerprint } : {})), { keyPoseUrl: parent.keyPoseUrl, keyPoseStoragePath: poseStoragePath, compositedFrames }), (editRecipe ? { editRecipe } : {})), { outputs,
        outputProfile, specReport: buildSpecReport({ plan, outputProfile, files }), analysisReused: true, motionFallbackReason: isEfficientLocalParent ? quickComposite_1.EFFICIENT_LOCAL_COMPOSITE_VERSION : null, completedAt: firestore_1.FieldValue.serverTimestamp() }));
}
async function repairExistingDynamicFrame(params) {
    ...
    const parentSnapshot = await parentRef.get();
    if (!parentSnapshot.exists)
        throw new Error('The completed parent animation could not be found.');
    const parent = parentSnapshot.data() || {};
    if (parent.userId !== params.userId
        || parent.status !== 'completed'
    ...
    if (typeof parent.sourceStoragePath !== 'string'
    ...
    const verifiedParent = (0, verifiedDynamicParent_1.verifyReusableDynamicParent)({
        parent,
        expectedFrameStoragePrefix: parentJobPrefix,
    });
    if (!verifiedParent.success) {
        throw new Error(`The parent animation is not eligible for safe frame reuse (${verifiedParent.reason}). `
    ...
    const outputProfileResult = schema_1.emoticonOutputProfileSchema.safeParse(parent.outputProfile);
    if (!outputProfileResult.success) {
        throw new Error('The verified parent output profile is unavailable.');
    }
    const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(outputProfileResult.data);
    const poseStoragePath = typeof parent.keyPoseStoragePath === 'string'
        ? parent.keyPoseStoragePath
        : '';
    ...
    const savedRepair = schema_1.emoticonFrameRepairSchema.safeParse(checkpoint.frameRepair);
    (0, repairContinuation_1.resolveEmoticonRepairCheckpointAction)({
        ...
        hasAcceptedPoseReview: Boolean(savedRepair.success
            && savedRepair.data.poseReview
            && (0, qualityStandards_1.meetsEmoticonDynamicKeyPoseAcceptance)(savedRepair.data.poseReview)),
        sequenceReviewCalls: savedRepair.success ? savedRepair.data.sequenceReviewCalls || 0 : 0,
        hasAcceptedSequenceReview: Boolean(savedRepair.success
    ...
    const parentSourceFingerprint = typeof parent.sourceFingerprint === 'string'
        ...
        : '';
    const repairIdentityFingerprint = (0, identityFingerprint_1.buildEmoticonIdentityFingerprint)({
        normalizedSourceFingerprint: parentSourceFingerprint,
        referenceSetFingerprint: canonicalReferenceSet.referenceSetFingerprint,
    });
    if (!parentSourceFingerprint
        || parent.identityFingerprintVersion !== identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION
    ...
    if (continuation.stage === 'repair-generation') {
        ...
        await params.update({
            ...
            frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'running' }),
        });
        ...
        await assertJobActive(params.userId, params.jobId);
        replacementBuffer = await (0, renderer_1.normalizeGeneratedEmoticonPose)(generated.buffer, {
        ...
        const variation = await (0, renderer_1.evaluateEmoticonFrameVariation)(frameBuffers, {
            requireSilhouetteVariation: (0, qualityStandards_1.getEmoticonMotionAcceptanceRequirements)(plan)
                .requireLimbMotion,
        });
        if (!variation.passes) {
        ...
        replacementAsset = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, uploadedReplacement), { contentType: 'image/png', generationModel: generated.model }), (generated.provider ? { generationProvider: generated.provider } : {})), { generationRequestId: generated.requestId, generationSeed: replacementSeed }), (generated.costUsd !== undefined ? { generationCostUsd: generated.costUsd } : {}));
    ...
    if (continuation.stage === 'repair-pose-review') {
        ...
        if (!(0, qualityStandards_1.meetsEmoticonDynamicKeyPoseAcceptance)(replacementPoseReview)) {
            await params.update({
            ...
            throw new Error('The replacement frame failed requested-action, identity, background, single-character, or occlusion acceptance.');
        }
        const nextContinuation = {
            stage: 'repair-sequence-review',
            retryCount: continuation.retryCount,
    ...
    if (continuation.stage === 'repair-sequence-review') {
        ...
        repairedMotionReview = await reviewImageFrameSequenceFailClosed({
            ...
            originalUserInstruction: params.request.instruction,
            additionalReferenceUrls: canonicalReferenceSet.urls,
            frameUrls: verifiedParent.animationFrames.map((frame, index) => (index === frameIndex ? replacementAsset.url : frame.url)),
            plan,
        });
    ...
    const animationFrames = await Promise.all(frameBuffers.map(async (buffer, index) => {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, asset), { contentType: 'image/png' }), (generation.generationModel ? { generationModel: generation.generationModel } : {})), (generation.generationProvider ? { generationProvider: generation.generationProvider } : {})), (generation.generationRequestId ? { generationRequestId: generation.generationRequestId } : {})), (generation.generationSeed !== undefined ? { generationSeed: generation.generationSeed } : {})), (generation.generationCostUsd !== undefined ? { generationCostUsd: generation.generationCostUsd } : {}));
    }));
    ...
    await params.update(Object.assign(Object.assign({ status: 'completed', progress: 100, statusMessage: `${frameIndex + 1}번 프레임을 교체하고 전체 파일 검사를 마쳤어요.`, plan, frameSequencePlan: verifiedParent.frameSequence, animationFrames,
        compositedFrames, repairedFrameIndex: frameIndex, frameRepair: {
            parentJobId: params.request.parentJobId,
            frameIndex,
            maxGenerationCalls: 1,
            generationCalls: 1,
            ...
            poseReview: replacementPoseReview,
            motionReview: repairedMotionReview,
        }, quality: replacementPoseReview, motionReview: repairedMotionReview, sourceImageUrl: canonicalSourceAsset.url, sourceStoragePath: parent.sourceStoragePath, sourceCanonicalStoragePath: canonicalSourceAsset.storagePath }, (parent.sourceFingerprint ? { sourceFingerprint: parent.sourceFingerprint } : {})), { referenceSetFingerprint: canonicalReferenceSet.referenceSetFingerprint, identityFingerprint: repairIdentityFingerprint, identityFingerprintVersion: identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION, keyPoseUrl: keyPoseAsset.url, keyPoseStoragePath: keyPoseAsset.storagePath, outputs: renderedOutputs, outputProfile, specReport: buildSpecReport({ plan, outputProfile, files }), analysisReused: true, motionFallbackReason: null, resumeAvailable: false, 'frameContinuation.state': 'completed', completedAt: firestore_1.FieldValue.serverTimestamp() }));
...
function efficientIdentityReviewReferences(identityReferenceUrl, additionalReferenceUrls = []) {
    var _a;
    const identityEvidence = (identityReferenceUrl === null || identityReferenceUrl === void 0 ? void 0 : identityReferenceUrl.trim())
        || ((_a = additionalReferenceUrls.find((url) => Boolean(url === null || url === void 0 ? void 0 : url.trim()))) === null || _a === void 0 ? void 0 : _a.trim());
...
async function runPostAnalysisPipeline(params) {
    ...
    const checkpoint = params.checkpoint || {};
    let selectedPoseBuffer = null;
    let selectedAsset = null;
    let correctedPoseBuffer = null;
    let correctedAsset = null;
    let quality = null;
    if (continuation.stage !== 'pose-generation') {
        ...
        const savedQuality = schema_1.emoticonQualitySchema.safeParse(checkpoint.quality);
        if (savedQuality.success)
            quality = savedQuality.data;
    }
    if (continuation.stage === 'pose-generation') {
        await ensureContinuationBudget({
            deadlineAtMs: params.deadlineAtMs,
        ...
        selectedPoseBuffer = await (0, renderer_1.normalizeGeneratedEmoticonPose)(generatedPose.buffer, {
            preserveDetachedComponents: params.plan.action.authorizedProps.length > 0
                || params.plan.action.motionAccents.length > 0,
        });
        ...
        await params.update({
            ...
            keyPoseGeneration: Object.assign(Object.assign(Object.assign({ model: generatedPose.model }, (generatedPose.provider ? { provider: generatedPose.provider } : {})), { requestId: generatedPose.requestId, seed: buildFrameSequenceSeed(params.jobId) }), (generatedPose.costUsd !== undefined ? { costUsd: generatedPose.costUsd } : {})),
            frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }),
            resumeAvailable: true,
        });
    }
    ...
    if (continuation.stage === 'pose-review') {
        ...
        quality = applyAlphaIsolationEvidence(await reviewPose({
            ...
            plan: params.plan,
        }), await (0, renderer_1.inspectEmoticonAlphaIsolation)(selectedPoseBuffer));
    ...
    if (continuation.stage === 'pose-correction') {
        if (!quality)
            throw new Error('The pose quality checkpoint required for correction is unavailable.');
        await ensureContinuationBudget({
            deadlineAtMs: params.deadlineAtMs,
            minimumRemainingMs: MIN_IMAGE_CALL_BUDGET_MS,
            userId: params.userId,
        ...
        correctedPoseBuffer = await (0, renderer_1.normalizeGeneratedEmoticonPose)(generatedCorrection.buffer, {
            preserveDetachedComponents: params.plan.action.authorizedProps.length > 0
                || params.plan.action.motionAccents.length > 0,
        });
        ...
        await params.update({
            ...
            correctionPoseGeneration: Object.assign(Object.assign(Object.assign({ model: generatedCorrection.model }, (generatedCorrection.provider ? { provider: generatedCorrection.provider } : {})), { requestId: generatedCorrection.requestId, seed: buildFrameSequenceSeed(params.jobId) ^ 0x2c9277b5 }), (generatedCorrection.costUsd !== undefined
    ...
    if (continuation.stage === 'corrected-pose-review') {
        if (!quality)
            throw new Error('The original pose quality checkpoint is unavailable.');
        ...
        const correctedQuality = applyAlphaIsolationEvidence(await reviewPose({
            ...
            plan: params.plan,
        }), await (0, renderer_1.inspectEmoticonAlphaIsolation)(correctedPoseBuffer));
        ...
        if ((correctedAccepted && !originalAccepted)
    ...
    if (!quality)
        throw new Error('The key pose quality checkpoint is unavailable.');
    if (needsPoseIsolationCorrection(quality, isDynamicRender(params.plan))) {
        throw new Error('The generated key pose failed subject-fidelity or isolated-character acceptance after correction. '
    ...
    await params.update(Object.assign(Object.assign(Object.assign({ status: 'completed', progress: 100, statusMessage: '이모티콘이 완성됐어요', plan: params.plan, quality: finalQuality, keyPoseUrl: selectedAsset.url, keyPoseStoragePath: selectedAsset.storagePath }, (rendered.animationFrames ? { animationFrames: rendered.animationFrames } : {})), (rendered.compositedFrames ? { compositedFrames: rendered.compositedFrames } : {})), { outputs, outputProfile: params.outputProfile, specReport: buildSpecReport({
            plan: params.plan,
            outputProfile: params.outputProfile,
            files: rendered.files,
        }), analysisReused: params.analysisReused, motionFallbackReason: rendered.motionFallbackReason, resumeAvailable: false, 'frameContinuation.state': 'completed', completedAt: firestore_1.FieldValue.serverTimestamp() }));
    await syncCompletedProjectItemNonFatal({
        userId: params.userId,
        jobId: params.jobId,
        request: params.request,
...
async function runAnalysisPipeline(params) {
    ...
    await params.update(Object.assign(Object.assign({ status: 'analyzing', progress: 8, statusMessage: '캐릭터 특징과 요청한 행동을 살펴보고 있어요', error: null, analysisReused: false, sourceImageUrl: params.sourceImageUrl, sourceCanonicalStoragePath: params.sourceStoragePath, sourceFingerprint: params.sourceFingerprint, referenceSetFingerprint: params.referenceSetFingerprint, canonicalReferenceUrls: params.additionalReferenceUrls }, (params.identityReferenceUrl
        ? { canonicalIdentityReferenceUrl: params.identityReferenceUrl }
        : {})), { identityFingerprint: params.identityFingerprint, identityFingerprintVersion: identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION, frameContinuation: Object.assign(Object.assign({}, continuation), { state: 'checkpointed' }), resumeAvailable: true }));
    const cachedAnalysis = params.request.mode === 'plan'
        ? null
        : await loadCharacterAnalysisCache(params.userId, params.request.sourceStoragePath, params.identityFingerprint, 1 + params.additionalReferenceUrls.length);
    if (cachedAnalysis)
        await params.update({ analysisReused: true });
    await ensureContinuationBudget({
        deadlineAtMs: params.deadlineAtMs,
        minimumRemainingMs: MIN_REVIEW_CALL_BUDGET_MS,
        userId: params.userId,
    ...
    await assertJobActive(params.userId, params.jobId);
    const analyzedPlan = await (0, director_1.analyzeEmoticonDirection)({
        apiKey: params.apiKey,
        model: params.model,
        fallbackModels: params.fallbackModels,
        sourceImageUrl: params.sourceImageUrl,
    ...
    const efficientDefaultMotion = (params.request.resourceMode === 'efficient'
        && params.request.mode === 'generate'
        && ((_a = params.request.outputProfile) === null || _a === void 0 ? void 0 : _a.type) !== 'static'
        && !params.request.motionOverride) ? { fps: 8, frameCount: 8, durationMs: 1000 } : undefined;
    const motionPlan = (0, director_1.applyEmoticonMotionOverride)(analyzedPlan, params.request.motionOverride || efficientDefaultMotion);
    const configuredPlan = Object.assign(Object.assign({}, (params.request.bubbleOverride
        ? Object.assign(Object.assign({}, motionPlan), { bubble: params.request.bubbleOverride }) : motionPlan)), (params.request.bubbleLayersOverride
        ? { bubbleLayers: params.request.bubbleLayersOverride }
        : {}));
    const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(params.request.outputProfile);
    const plan = (0, outputPlanPolicy_1.normalizeEmoticonPlanForOutputProfile)(configuredPlan, outputProfile);
    ...
    await params.update({
        plan,
        outputProfile,
        frameContinuation: Object.assign(Object.assign({}, next), { state: 'checkpointed' }),
        resumeAvailable: true,
    });
    await runPostAnalysisPipeline(Object.assign(Object.assign({}, params), { plan,
        outputProfile, analysisReused: Boolean(cachedAnalysis), continuation: next }));
}
async function requireEmoticonRecoveryAdmin(uid, token) {
    var _a;
    ...
    if (adminDocument.exists || ((_a = accessDocument.data()) === null || _a === void 0 ? void 0 : _a.role) === 'admin')
        return;
    throw new https_1.HttpsError('permission-denied', '관리자만 이모티콘 작업을 복구할 수 있습니다.');
}
function recoverySkipError(reason) {
    if (reason === 'not-found') {
        return new https_1.HttpsError('not-found', '복구할 이모티콘 작업을 찾을 수 없습니다.');
    }
    if (reason === 'owner-mismatch') {
        return new https_1.HttpsError('permission-denied', '이 작업을 복구할 권한이 없습니다.');
    }
    if (reason === 'cancelled') {
        return new https_1.HttpsError('failed-precondition', '취소된 작업은 복구할 수 없습니다.');
    }
    if (reason === 'terminal') {
        return new https_1.HttpsError('failed-precondition', '이미 종료된 작업은 중단 복구 대상이 아닙니다.');
    }
    if (reason === 'deferred') {
        return new https_1.HttpsError('failed-precondition', '비용 보호 대기열에 예약된 작업은 순서가 되면 자동 시작합니다.');
    }
    if (reason === 'batch-concurrency') {
        return new https_1.HttpsError('failed-precondition', '배치 동시 실행 슬롯이 비면 작업이 자동으로 복구됩니다.');
    }
    if (reason === 'missing-execution-authorization') {
        return new https_1.HttpsError('failed-precondition', '서버 비용 승인 또는 요청 제한 예약이 없어 자동 복구를 중단했습니다. 새 작업을 만들어 주세요.');
    }
    if (reason === 'invalid-batch-execution') {
        return new https_1.HttpsError('failed-precondition', '배치 또는 프로젝트 실행 경계가 변경되어 작업을 복구할 수 없습니다.');
    }
    if (reason === 'missing-checkpoint') {
        return new https_1.HttpsError('failed-precondition', '안전하게 이어갈 체크포인트가 없어 자동 복구를 중단했습니다.');
    }
    if (reason === 'invalid-request') {
        return new https_1.HttpsError('failed-precondition', '저장된 작업 요청을 안전하게 복구할 수 없습니다.');
    }
    if (reason === 'existing-continuation') {
        return new https_1.HttpsError('failed-precondition', '기존 이어서 만들기 요청을 확인 중입니다. 잠시 기다려 주세요.');
    }
    if (reason === 'stale-project-item-lease') {
        return new https_1.HttpsError('failed-precondition', '프로젝트 항목을 다른 작업이 사용 중이어서 이 작업은 재개하지 않습니다.');
    }
    return new https_1.HttpsError('failed-precondition', '기존 서버 작업이 아직 실행 중일 수 있어 지금은 복구할 수 없습니다.');
}
async function restoreRecoverableCostReservation(userId, jobId) {
    const jobRef = firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`);
    const rateLimitRef = firestore_3.db.doc(`emoticonStudioRateLimits/${userId}`);
    const nowMs = Date.now();
    await firestore_3.db.runTransaction(async (transaction) => {
        ...
        if (!jobSnapshot.exists)
            throw new https_1.HttpsError('not-found', '이어 만들 작업을 찾을 수 없습니다.');
        const job = jobSnapshot.data() || {};
        if (job.userId !== userId)
            throw new https_1.HttpsError('permission-denied', '이 작업을 이어 만들 권한이 없습니다.');
        ...
        if (!job.costReservationSettledAt)
            return;
        if (job.costControlVersion === rateLimits_1.EMOTICON_COST_CONTROL_VERSION) {
            ...
            if (!validAuthorization || !validDailyLimit) {
                throw new https_1.HttpsError('failed-precondition', 'The per-request OpenRouter cost gate is incomplete.');
            }
            ...
            transaction.update(jobRef, {
                costReservationSettledAt: firestore_1.FieldValue.delete(),
                costReservationAccountedUsd: firestore_1.FieldValue.delete(),
                updatedAt: firestore_1.FieldValue.serverTimestamp(),
            });
            return;
        }
        if (job.costControlVersion !== rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION) {
            throw new https_1.HttpsError('failed-precondition', 'The OpenRouter cost control version is not recoverable.');
        }
        const authorizedUsd = typeof job.openRouterAuthorizedCostUsd === 'number'
            ? Math.max(0, job.openRouterAuthorizedCostUsd)
            : 0;
        ...
        if (requestedUsd <= 0)
            return;
        const rateLimit = rateLimitSnapshot.data() || {};
        const allocation = (0, rateLimits_1.allocateEmoticonCostReservation)({
            nowMs,
            dailyLimitUsd: EMOTICON_COST_LIMITS.dailyUsd,
            requestedUsd,
            state: {
                dayBucket: rateLimit.costReservationDayBucket,
                reservedUsd: rateLimit.costReservedUsd,
                reservationsByDay: rateLimit.costReservationsByDay,
            },
        });
        if (allocation.executeAtMs > nowMs + 2000) {
            throw new https_1.HttpsError('resource-exhausted', '오늘 비용 보호 한도 때문에 지금은 이어 만들 수 없습니다. 다음 예약 시간 이후 다시 시도해 주세요.');
        }
        transaction.set(rateLimitRef, {
            ...
            costReservationVersion: rateLimits_1.LEGACY_EMOTICON_COST_CONTROL_VERSION,
 ...
 */
exports.recoverStalledEmoticonJob = (0, https_1.onCall)({
    region: 'asia-northeast3',
    timeoutSeconds: 30,
    memory: '256MiB',
    maxInstances: 20,
    ...
    await requireEmoticonRecoveryAdmin(userId, (((_b = request.auth) === null || _b === void 0 ? void 0 : _b.token) || {}));
    const jobId = typeof ((_c = request.data) === null || _c === void 0 ? void 0 : _c.jobId) === 'string'
        ? request.data.jobId.trim()
        : '';
    if (!/^[A-Za-z0-9_-]{1,160}$/.test(jobId)) {
        throw new https_1.HttpsError('invalid-argument', '복구할 작업 번호가 올바르지 않습니다.');
    }
    await restoreRecoverableCostReservation(userId, jobId);
    const recovery = await (0, jobRecovery_1.recoverStalledEmoticonJobInPlace)({ userId, jobId });
    if (recovery.outcome === 'skipped')
        throw recoverySkipError(recovery.reason);
...
exports.onEmoticonJobCreated = (0, firestore_2.onDocumentCreated)(triggerConfig, async (event) => {
    ...
    return (0, openrouterUsage_1.runWithOpenRouterUsageContext)({ userId, jobId, stage: 'job' }, async () => {
        ...
        const update = async (data) => {
            if (!activeRunToken)
                throw new Error('The emoticon job worker has not claimed its lease.');
            await updateActiveJob(userId, jobId, data, { generationRunToken: activeRunToken });
        };
        let linkedProjectRequest = null;
        try {
            ...
            (0, openrouterUsage_1.updateOpenRouterUsageContext)({
            ...
            if (parsed.data.referenceImages.some((reference) => (!reference.sourceStoragePath.startsWith(expectedSourcePrefix)))) {
                throw new Error('A character reference image does not belong to this user.');
            }
            const resolvedPlatformPolicy = await (0, platformPolicy_1.resolveEmoticonGenerationPolicy)({
            ...
            if (parsed.data.mode === 'import_frames') {
                ...
                logger.info('[EmoticonStudio] Manual frame import completed without AI or provider quota use.', {
                    userId,
                    jobId,
                    frameCount: (_b = parsed.data.manualImport) === null || _b === void 0 ? void 0 : _b.frames.length,
                    formats: parsed.data.formats,
                });
                return;
            }
            const reservation = await reserveRateLimitSlot({
                ...
                requestedFrameCount: (_d = (_c = parsed.data.motionOverride) === null || _c === void 0 ? void 0 : _c.frameCount) !== null && _d !== void 0 ? _d : (parsed.data.resourceMode === 'efficient'
                    && ((_e = parsed.data.outputProfile) === null || _e === void 0 ? void 0 : _e.type) !== 'static'
                    && parsed.data.mode === 'generate'
                    ? 8
                    : undefined),
                outputType: (_f = parsed.data.outputProfile) === null || _f === void 0 ? void 0 : _f.type,
            ...
            const batchSlot = await (0, batches_1.claimEmoticonBatchExecutionSlot)({
                userId,
                jobId,
                batchId: parsed.data.batchId,
                projectId: parsed.data.projectId,
            ...
            if (batchSlot === 'deferred') {
                const executeAtMs = Date.now() + 30000;
                await deferJobUntilReservedSlot({
                    userId,
                    jobId,
                    executeAtMs,
            ...
            if (parsed.data.mode === 'generate'
                ...
                && parsed.data.aiGenerationProfile !== modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE) {
                ...
                logger.info('[EmoticonStudio] Zero-provider local composite completed.', {
                    userId,
                    jobId,
                    frameCount: ((_g = parsed.data.outputProfile) === null || _g === void 0 ? void 0 : _g.type) === 'static'
                        ? 1
                        : ((_h = parsed.data.motionOverride) === null || _h === void 0 ? void 0 : _h.frameCount) || 8,
                    formats: parsed.data.formats,
                });
                return;
            }
            ...
            const identityFingerprint = (0, identityFingerprint_1.buildEmoticonIdentityFingerprint)({
            ...
            if (error instanceof EmoticonJobCancelledError
            ...
            if (error instanceof EmoticonProjectDeletionLockedError) {
                ...
                logger.info('[EmoticonStudio] Refused a job for a deletion-locked project.', {
                    userId,
                    jobId,
                    projectId: linkedProjectRequest === null || linkedProjectRequest === void 0 ? void 0 : linkedProjectRequest.projectId,
                });
                return;
            }
            ...
            if (error instanceof openrouterUsage_1.OpenRouterDailyCostLimitError || isOpenRouterCreditError(error)) {
                const dailyLimitReached = error instanceof openrouterUsage_1.OpenRouterDailyCostLimitError;
                await update(Object.assign(Object.assign({ status: 'failed', progress: 100, statusMessage: dailyLimitReached
                        ? '오늘 비용 보호 한도에 도달했어요. 자정 이후 저장된 단계부터 이어 만들 수 있어요.'
                        : 'OpenRouter 크레딧을 충전하면 저장된 단계부터 이어 만들 수 있어요.', error: safeErrorMessage(error), resumeAvailable: true, recoverableFailure: dailyLimitReached ? 'checkpoint-error' : 'openrouter-credits' }, (dailyLimitReached
                    ? { dailyCostPausedAt: firestore_1.FieldValue.serverTimestamp() }
                    : { creditPausedAt: firestore_1.FieldValue.serverTimestamp() })), { 'frameContinuation.state': 'checkpointed', failedAt: firestore_1.FieldValue.serverTimestamp() })).catch(() => undefined);
            ...
            if ((linkedProjectRequest === null || linkedProjectRequest === void 0 ? void 0 : linkedProjectRequest.mode) === 'generate'
                && (0, imageGeneration_1.isDefiniteImageRouteCompatibilityError)(error)) {
            ...
            await update(Object.assign(Object.assign(Object.assign(Object.assign({ status: 'failed', progress: 100, statusMessage: providerTimeout
                    ? '느린 이미지 공급 경로를 제외했어요. 다른 경로로 다시 생성할 수 있습니다.'
                    : renderFailureRecovery
                        ? '파일 조립이 일시 중단됐어요. 저장된 프레임부터 다시 이어 만들 수 있어요.'
                        : '작업을 완료하지 못했어요', error: failureMessage, resumeAvailable: Boolean(renderFailureRecovery) }, (providerTimeout
                ? {
                ...
                : {})), (renderFailureRecovery ? { renderFailureRecovery } : {})), { 'frameContinuation.state': renderFailureRecovery ? 'checkpointed' : 'failed', failedAt: firestore_1.FieldValue.serverTimestamp() })).catch((updateError) => {
...
exports.onEmoticonJobCancellationRequested = (0, firestore_2.onDocumentUpdated)(cancellationTriggerConfig, async (event) => {
    var _a, _b;
    ...
    const userId = event.params.userId;
    const jobId = event.params.jobId;
    if (!isSafeFirebaseUid(userId) || !/^[A-Za-z0-9_-]{1,160}$/.test(jobId))
        return;
    const cancelled = await finalizeJobCancellation(userId, jobId);
    if (!cancelled)
        return;
    const request = schema_1.emoticonJobRequestSchema.safeParse(Object.assign(Object.assign({}, after), { status: 'queued' }));
    if (request.success) {
        await syncLinkedProjectItem({
            userId,
            jobId,
...
exports.onEmoticonJobTerminalSettled = (0, firestore_2.onDocumentUpdated)(Object.assign(Object.assign({}, cancellationTriggerConfig), { retry: true }), async (event) => {
    var _a, _b, _c, _d;
    const beforeStatus = String(((_b = (_a = event.data) === null || _a === void 0 ? void 0 : _a.before.data()) === null || _b === void 0 ? void 0 : _b.status) || '');
    const afterStatus = String(((_d = (_c = event.data) === null || _c === void 0 ? void 0 : _c.after.data()) === null || _d === void 0 ? void 0 : _d.status) || '');
    if (!TERMINAL_JOB_STATUSES.has(afterStatus) || TERMINAL_JOB_STATUSES.has(beforeStatus))
        return;
    await settleTerminalJobCostReservation(event.params.userId, event.params.jobId);
});
exports.onEmoticonJobContinuationCreated = (0, firestore_2.onDocumentCreated)(continuationTriggerConfig, async (event) => {
    var _a;
    const snapshot = event.data;
    if (!snapshot)
        return;
    ...
    const parsedContinuationDocument = schema_1.emoticonContinuationDocumentSchema.safeParse(rawContinuation);
    if (!parsedContinuationDocument.success) {
        await continuationRef.set({
            status: 'invalid',
            error: ((_a = parsedContinuationDocument.error.issues[0]) === null || _a === void 0 ? void 0 : _a.message) || 'Invalid continuation identity.',
            expiresAt: continuationExpiresAt(),
            updatedAt: firestore_1.FieldValue.serverTimestamp(),
        }, { merge: true });
        return;
    }
    const { userId, jobId, token, runToken, } = parsedContinuationDocument.data;
    ...
    return (0, openrouterUsage_1.runWithOpenRouterUsageContext)({ userId, jobId, stage: 'continuation' }, async () => {
        var _a;
        const jobRef = firestore_3.db.doc(`users/${userId}/emoticonJobs/${jobId}`);
        const nowMs = Date.now();
        const claim = await firestore_3.db.runTransaction(async (transaction) => {
            ...
            if (savedContinuation.token !== token
            ...
            const savedStage = savedContinuation.stage;
            const savedPoseQuality = schema_1.emoticonQualitySchema.safeParse(job.quality);
            const savedPlan = schema_1.emoticonStoredPlanSchema.safeParse(job.plan);
            const savedPoseAccepted = savedPoseQuality.success && (savedPlan.success && isDynamicRender(savedPlan.data)
                ? (0, qualityStandards_1.meetsEmoticonDynamicKeyPoseAcceptance)(savedPoseQuality.data)
                : (0, qualityStandards_1.meetsEmoticonPoseAcceptance)(savedPoseQuality.data));
            const renderFailureRecoveryEligible = (savedStage === 'static-render'
                || savedStage === 'render') && savedPoseAccepted;
            ...
            if (deliveryAttempts >= MAX_CONTINUATION_DELIVERY_ATTEMPTS) {
                ...
                transaction.update(jobRef, Object.assign(Object.assign({ status: 'failed', progress: 100, statusMessage: '반복된 연결 문제로 작업을 중단했어요.', error: '일시적인 연결 문제가 반복됐어요. 잠시 후 새 작업으로 다시 시도해 주세요.', resumeAvailable: false }, (renderFailureRecoveryEligible
                    ? {
                        renderFailureRecovery: {
                            stage: 'render',
                            category: 'infrastructure',
                    ...
                    : {})), { 'frameContinuation.state': 'failed', failedAt: firestore_1.FieldValue.serverTimestamp(), updatedAt: firestore_1.FieldValue.serverTimestamp() }));
                return 'exhausted';
            }
            transaction.update(continuationRef, {
                status: 'running',
        ...
        if (claim === 'exhausted') {
            ...
            const exhaustedRequest = schema_1.emoticonJobRequestSchema.safeParse(Object.assign(Object.assign({}, (exhaustedJob.data() || {})), { status: 'queued' }));
        ...
        let requestForProjectSync = null;
        try {
            await assertJobActive(userId, jobId);
            const jobSnapshot = await jobRef.get();
            if (!jobSnapshot.exists)
                throw new Error('The emoticon job for continuation is unavailable.');
            const job = jobSnapshot.data() || {};
            const request = schema_1.emoticonJobRequestSchema.safeParse(Object.assign(Object.assign({}, job), { status: 'queued' }));
            if (!request.success) {
                throw new Error(`Invalid continued emoticon job: ${((_a = request.error.issues[0]) === null || _a === void 0 ? void 0 : _a.message) || 'unknown error'}`);
            }
            ...
            const plan = schema_1.emoticonStoredPlanSchema.safeParse(job.plan);
            const continuation = parseContinuationState(job.frameContinuation, plan.success ? plan.data.action.frameCount : undefined);
            ...
            if (request.data.mode === 'generate'
                && request.data.resourceMode === 'efficient'
                && request.data.aiGenerationProfile !== modelPolicy_1.EMOTICON_GPT_LIGHT_PROFILE) {
                const preparedSource = await prepareCanonicalSource({
                    userId,
                    jobId,
            ...
            if (!canonicalReferenceCheckpoint) {
                await update(Object.assign(Object.assign({ canonicalReferenceUrls: canonicalReferenceSet.urls }, (canonicalReferenceSet.identitySheetUrl
            ...
            if (!isFrameContinuationState(continuation)) {
                if (continuation.stage === 'analysis') {
                    ...
                    if (!sourceStoragePath
                        || !sourceFingerprint
                        || job.identityFingerprintVersion !== identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION) {
                        const preparedSource = await prepareCanonicalSource({
                            userId,
                            jobId,
                            sourceStoragePath: request.data.sourceStoragePath,
                    ...
                    const storedSourceFingerprint = typeof job.sourceFingerprint === 'string'
                        ? job.sourceFingerprint
                        : '';
                    const currentIdentityFingerprint = (0, identityFingerprint_1.buildEmoticonIdentityFingerprint)({
                        normalizedSourceFingerprint: storedSourceFingerprint,
                        referenceSetFingerprint: canonicalReferenceSet.referenceSetFingerprint,
                    });
                    if (!storedSourceFingerprint
                        || job.identityFingerprintVersion !== identityFingerprint_1.EMOTICON_IDENTITY_FINGERPRINT_VERSION
                    ...
                    const outputProfileResult = schema_1.emoticonOutputProfileSchema.safeParse(job.outputProfile);
                    const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(outputProfileResult.success ? outputProfileResult.data : request.data.outputProfile);
                    await runPostAnalysisPipeline({
                        ...
                        identityReferenceUrl: canonicalReferenceSet.identitySheetUrl,
                        additionalReferenceUrls,
                        plan: (0, outputPlanPolicy_1.normalizeEmoticonPlanForOutputProfile)(plan.data, outputProfile),
                        outputProfile,
            ...
            const outputProfileResult = schema_1.emoticonOutputProfileSchema.safeParse(job.outputProfile);
            const outputProfile = (0, renderer_1.resolveEmoticonOutputProfile)(outputProfileResult.success ? outputProfileResult.data : request.data.outputProfile);
            const animationFramesResult = schema_1.emoticonAnimationFrameSchema.array()
            ...
            const frameSequenceResult = schema_1.emoticonFrameSequenceSchema.safeParse(job.frameSequencePlan);
            if (!frameSequenceResult.success && continuation.stage !== 'planning') {
                throw new Error('The saved frame sequence plan is invalid.');
            }
            const motionReviewResult = schema_1.emoticonMotionReviewSchema.safeParse(job.motionReview);
            ...
            const storedPoseQuality = schema_1.emoticonQualitySchema.safeParse(job.quality);
            await update({
                status: 'completed',
                progress: 100,
            ...
            if (error instanceof openrouterUsage_1.OpenRouterDailyCostLimitError || isOpenRouterCreditError(error)) {
                ...
                await update(Object.assign(Object.assign({ status: 'failed', progress: 100, statusMessage: dailyLimitReached
                        ...
                        : 'OpenRouter 크레딧을 충전하면 저장된 프레임부터 이어 만들 수 있어요.', error: message, resumeAvailable: true, recoverableFailure: dailyLimitReached ? 'checkpoint-error' : 'openrouter-credits' }, (dailyLimitReached
                    ? { dailyCostPausedAt: firestore_1.FieldValue.serverTimestamp() }
                    : { creditPausedAt: firestore_1.FieldValue.serverTimestamp() })), { 'frameContinuation.state': 'checkpointed', failedAt: firestore_1.FieldValue.serverTimestamp() })).catch(() => undefined);
                await continuationRef.update({
                    status: 'failed',
            ...
            if ((requestForProjectSync === null || requestForProjectSync === void 0 ? void 0 : requestForProjectSync.mode) === 'generate'
                && (0, imageGeneration_1.isDefiniteImageRouteCompatibilityError)(error)) {
                const message = safeErrorMessage(error);
                await update({
                    status: 'failed',
            ...
            await update({
                ...
                error: message,
                resumeAvailable: false,
                recoverableFailure: firestore_1.FieldValue.delete(),
