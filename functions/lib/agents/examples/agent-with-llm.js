...
exports.LLMCodeAgent = exports.LLMAnalyzerAgent = void 0;
...
// ============================================
class LLMAnalyzerAgent extends Agent_1.BaseAgent {
    constructor() {
        super(...arguments);
...
Return ONLY valid JSON, no markdown or explanations.`,
            ...
            logs.push(`[LLMAnalyzer] LLM responded (${(_a = llmResponse.usage) === null || _a === void 0 ? void 0 : _a.totalTokens} tokens)`);
            // Parse LLM response as JSON
            const analysisData = JSON.parse(llmResponse.content);
            // Validate with Zod
            const validatedAnalysis = schemas_1.analyzerOutputSchema.parse(analysisData);
...
exports.LLMAnalyzerAgent = LLMAnalyzerAgent;
// ============================================
// Example 2: LLM-Powered Code Generator
// ============================================
class LLMCodeAgent extends Agent_1.BaseAgent {
    constructor() {
        super(...arguments);
        this.llm = LLMAdapter_1.LLMAdapterFactory.fromEnv();
    }
...
Return ONLY the code, no explanations or markdown code blocks.`,
            ...
            logs.push(`[LLMCode] Code generated (${(_a = llmResponse.usage) === null || _a === void 0 ? void 0 : _a.totalTokens} tokens)`);
            const codeOutput = {
...
exports.LLMCodeAgent = LLMCodeAgent;
// ============================================
 ...
 */
//# sourceMappingURL=agent-with-llm.js.map