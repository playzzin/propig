export type EmoticonRepairContinuationStage =
    | 'repair-generation'
    | 'repair-pose-review'
    | 'repair-sequence-review'
    | 'repair-render';

export type EmoticonRepairCheckpointAction =
    | 'generate-replacement'
    | 'review-replacement-pose'
    | 'review-full-sequence'
    | 'render-repaired-sequence';

export function resolveEmoticonRepairCheckpointAction(params: {
    stage: EmoticonRepairContinuationStage;
    generationCalls: number;
    hasReplacement: boolean;
    poseReviewCalls: number;
    hasAcceptedPoseReview: boolean;
    sequenceReviewCalls: number;
    hasAcceptedSequenceReview: boolean;
}): EmoticonRepairCheckpointAction {
