...
export const Login: React.FC<LoginProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed top-16 right-4 z-50" ref={dropdownRef}>
        ...
        <div className="p-4">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              disabled={loading}
              className="mt-3 w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:bg-gray-100 transition-colors"
            >
