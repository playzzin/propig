...
export const CORP_PAGE_DEFINITIONS: CorpPageDefinition[] = [
  {
    ...
    checkpoints: [
      ...
      '대표소개, 직원소개, 제품소개로 이어지는 탐색 흐름을 제공합니다.',
  ...
  },
  {
    ...
    menuLabel: '채용정보',
    title: '채용정보',
    description: 'Propig이 함께 일하고 싶은 방식과 관심 분야, 인재풀·협업 제안 경로를 솔직하게 안내합니다.',
    checkpoints: [
      '확정 공고와 인재풀 접수를 명확히 구분하고 검증되지 않은 채용 조건을 약속하지 않습니다.',
      '지원자가 역할, 일하는 방식, 기대와 전형 원칙을 지원 전에 판단할 수 있게 안내합니다.',
      '경력과 스펙보다 문제 해결 과정, 상호 존중, 안전한 소통을 기본 원칙으로 둡니다.',
    ],
  },
  {
    ...
    menuLabel: '지원하기',
    title: '지원하기',
    description: '관심 분야와 경험을 정리하고 이메일 앱에서 최종 검토 후 직접 보내는 안전한 지원 흐름입니다.',
    checkpoints: [
      '관심 분야, 연락 정보, 문제 해결 경험과 지원 동기를 단계별로 작성할 수 있게 구성합니다.',
      '필수 입력 오류를 해당 필드와 연결하고 초안을 브라우저에만 안전하게 보존합니다.',
      '서버 자동 제출 없이 이메일 앱에서 내용과 첨부 파일을 최종 확인한 뒤 직접 전송하게 안내합니다.',
    ],
  },
];
